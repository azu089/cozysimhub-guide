...
function renderStatic(slug, lang) {
  ...
  const BODY_I18N = {
    "en": {
      "about": `${esc(siteI18n(lang).name)} is an unofficial fan resource for Sovereign Tower. We research every page against the official Steam store page, fan wiki data and community reports, and clearly mark anything still being verified.`,
    ...
    "fr": {
      "about": "Ce site est une ressource de fans non officielle pour Sovereign Tower. Nous vérifions chaque page sur la page Steam officielle, les wikis de fans et les rapports de la communauté.",
    ...
    "de": {
      "about": "Diese Seite ist eine inoffizielle Fan-Ressource für Sovereign Tower. Wir prüfen jede Seite gegen den offiziellen Steam-Store, Fan-Wikis und Community-Berichte.",
