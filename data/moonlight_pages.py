    ...
    "ja": {
        ...
        "sections": {
            0: {"headers": ["仕組み", "内容"], "rows": [
                ...
                ["デート対象外 NPC", "10人以上のNPCとも贈り物で友情を。クエストと「Social Butterfly」実績に。"],
            ]},
    ...
    "ko": {
        ...
        "sections": {
            0: {"headers": ["시스템", "방식"], "rows": [
                ...
                ["데이트 불가 NPC", "10명 이상의 NPC도 선물로 우정 가능. 퀘스트와 'Social Butterfly' 업적에 유용."],
            ]},
            1: {"heading": "우정 마일스톤"},
        },
    },
    ...
    "de": {
        ...
        "sections": {
            0: {"headers": ["Mechanik", "Funktionsweise"], "rows": [
                ...
                ["Verabredungen", "Minispiele; können scheitern (Verspätung, Anweisungen) — Verlust an Punkten."],
...
# =====================================================================
# G3 site-writer：ja/ko/fr/de 表格正文 rows 审译（镜像 zh-CN 的专名保留规则）
# =====================================================================
MP_ROWS_I18N = {'moonlight-peaks': {'ja': {1: {'rows': [['贈り物ガイド', '全キャラの大好物・好物・嫌いな物を検索できる表で。'],
                                         ['恋愛ガイド', 'デート可能な23人、ハート、デート、結婚、吸血鬼化。'],
                                         ['釣りガイド', '全魚、場所、満月限定、釣り竿強化。'],
                                         ['花ガイド', '全花の季節・場所・価値。'],
                                         ['道具強化', '全道具の銅/鉄/金コストと素材。'],
                                         ['実績', '全59個の実績と解除方法。'],
                                         ['攻略', 'メインストーリーを第1〜8部まで順に。']]}},
                     'ko': {1: {'rows': [['선물 가이드', '모든 캐릭터의 최애·좋아함·싫어함 선물을 검색 가능한 표로.'],
                                         ['연애 가이드', '데이트 가능 23명, 하트, 데이트, 결혼, 뱀파이어 전환.'],
                                         ['낚시 가이드', '모든 물고기, 위치, 보름달 한정, 낚싯대 강화.'],
                                         ['꽃 가이드', '모든 꽃의 계절·위치·가치.'],
                                         ['도구 강화', '모든 도구의 구리/철/금 비용과 재료.'],
                                         ['업적', '전체 59개 업적과 해금 방법.'],
                                         ['공략', '메인 스토리를 1부~8부까지 단계별로.']]}},
                     'fr': {1: {'rows': [['Guide des cadeaux',
                                          'Les cadeaux adorés / aimés / détestés de chaque personnage, dans '
                                          'un tableau filtrable.'],
                                         ['Guide romance',
                                          'Les 23 personnages, niveaux de cœur, rendez-vous, mariage et '
                                          'conversion en vampire.'],
                                         ['Guide de pêche',
                                          'Tous les poissons, lieux, exclusifs pleine lune et améliorations '
                                          'de canne.'],
                                         ['Guide des fleurs', 'Chaque fleur par saison, lieu et valeur.'],
                                         ["Améliorations d'outils",
                                          'Coûts cuivre / fer / or et matériaux pour chaque outil.'],
                                         ['Succès', 'Les 59 succès et comment les débloquer.'],
                                         ['Soluce', "L'histoire principale pas à pas, parties 1 à 8."]]}},
                     'de': {1: {'rows': [['Geschenke-Guide',
                                          'Die geliebten / gemochten / gehassten Geschenke jedes Charakters '
                                          'in einer filterbaren Tabelle.'],
                                         ['Romantik-Guide',
                                          'Alle 23 datierbaren Charaktere, Herzstufen, Dates, Heirat und '
                                          'Vampir-Wandlung.'],
                                         ['Angel-Guide',
                                          'Alle Fische, Orte, Vollmond-Exklusiven und Ruten-Upgrades.'],
                                         ['Blumen-Guide', 'Jede Blume nach Saison, Ort und Wert.'],
                                         ['Werkzeug-Upgrades',
                                          'Kupfer- / Eisen- / Gold-Kosten und Materialien für jedes '
                                          'Werkzeug.'],
                                         ['Erfolge', 'Alle 59 Erfolge und wie man sie freischaltet.'],
                                         ['Komplettlösung',
                                          'Die Hauptstory Schritt für Schritt, Teil 1 bis 8.']]}}},
 'moonlight-peaks/romance': {'ja': {0: {'rows': [['Fiona',
                                                  '魔女',
                                                  '1年目 春1日',
                                                  '最初は無関心でよそよそしい。Orlock と確執があるが、その奥に深い物語を隠している。'],
                                                 ['Noel', '魔女', '1年目 春1日', '傲慢で自己中心的、釣り好き。高慢な態度は不安の裏返し。'],
                                                 ['Sabrina', '魔女', '1年目 春1日', '献身的で賢い魔女。時に家族のことで手一杯になる。'],
                                                 ['Luna', '魔女', '1年目 春1日', '謎めいていて、庭で過ごすことが多い。魔法に深く通じている。'],
                                                 ['Orlock',
                                                  '吸血鬼',
                                                  '1年目 春1日',
                                                  '過去に苦しみアルコール問題を抱える吸血鬼。回復するにつれロマンチックで素直な一面が開花する。'],
                                                 ['Evan',
                                                  '吸血鬼',
                                                  '1年目 春1日',
                                                  'Orlock ののんびり屋の子。Orlock の転落ぶりに悩んでいる。'],
                                                 ['Mina',
                                                  '吸血鬼',
                                                  '1年目 春1日',
                                                  '明るく興奮しやすい Orlock のもう一人の子で Evan の妹。家族を心配している。'],
                                                 ['Samael', '吸血鬼', '1年目 春1日', 'Orlock の甥。陰があり、神秘的で優しい。'],
                                                 ['Elvira', '吸血鬼', '1年目 春1日', '元気でやる気に満ち、いつも交流イベントを企画している。'],
                                                 ['Persephone', '人間', '1年目 夏24日', '姪と甥を連れて引っ越してきた好奇心旺盛な人間。'],
                                                 ['Jada', '人間', 'Persephone のクエスト進行で', '熱心な遺物収集家。ゲーム後半で解放。'],
                                                 ['Winston',
                                                  '人間',
                                                  'Persephone のクエスト進行で',
                                                  '超自然的存在をひどく怖がる。恐怖と向き合うのが彼の物語。'],
                                                 ['Saga', '狼人', '1年目 春1日', 'Orlock と父 Brook の確執を和らげようとしている。'],
                                                 ['Ridge',
                                                  '狼人',
                                                  '1年目 春1日',
                                                  'Brook ののんびり屋の弟。Howling Hammer を経営し、Ludo の父。'],
                                                 ['Ludo', '狼人', '1年目 春1日', 'のんきな悪戯っ子で、いつも Brook に怒られている。'],
                                                 ['Dragan',
                                                  '予言者',
                                                  '1年目 春1日',
                                                  '予知に悩みながら、カードゲーム（Nokturna）を磨いている。'],
                                                 ['Alina', '予言者', '1年目 春1日', '情熱的で激しい性格。Dragan にはあまり我慢できない。'],
                                                 ['Aras',
                                                  '予言者',
                                                  '1年目 春1日',
                                                  '洋服店 Third Eye Threads を経営。優しく物腰が柔らかい。'],
                                                 ['Death', '超自然的存在', 'ストーリー進行で', '仕事に疲れている。手を貸すと面倒見が良くなる。'],
                                                 ['Llemi', '超自然的存在', '春・Lovage 祭りの前', '愛の悪魔。どの交流も印象に残る。'],
                                                 ['Kim', '人魚', '隠し（未定）', '隠し恋愛候補。'],
                                                 ['Tae', '人魚', '隠し（未定）', '隠し恋愛候補。'],
                                                 ['Rei', '人魚', '隠し（未定）', '隠し恋愛候補。']]}},
                             'ko': {0: {'rows': [['Fiona',
                                                  '마녀',
                                                  '1년차 봄 1일',
                                                  '처음에는 냉담하고 무관심. Orlock과 앙숙이지만 그 안에 깊은 사연이 숨어 있다.'],
                                                 ['Noel',
                                                  '마녀',
                                                  '1년차 봄 1일',
                                                  '거만하고 자기중심적이며 낚시를 좋아함. 오만한 겉모습은 불안함을 감춘 것.'],
                                                 ['Sabrina',
                                                  '마녀',
                                                  '1년차 봄 1일',
                                                  '헌신적이고 영리한 마녀. 때로 가족 일에 벅차한다.'],
                                                 ['Luna', '마녀', '1년차 봄 1일', '신비롭고 정원에서 시간을 보냄. 마법에 정통하다.'],
                                                 ['Orlock',
                                                  '뱀파이어',
                                                  '1년차 봄 1일',
                                                  '알코올 문제로 괴로워하는 뱀파이어. 회복하며 로맨틱하고 솔직한 면이 피어난다.'],
                                                 ['Evan',
                                                  '뱀파이어',
                                                  '1년차 봄 1일',
                                                  'Orlock의 느긋한 자식. Orlock이 무너져 가는 모습에 괴로워한다.'],
                                                 ['Mina',
                                                  '뱀파이어',
                                                  '1년차 봄 1일',
                                                  '밝고 활기찬 Orlock의 또 다른 자식이자 Evan의 여동생. 가족을 걱정한다.'],
                                                 ['Samael',
                                                  '뱀파이어',
                                                  '1년차 봄 1일',
                                                  'Orlock의 조카. 어둡고 신비로우며 친절하다.'],
                                                 ['Elvira', '뱀파이어', '1년차 봄 1일', '활기차고 의욕적. 항상 모임을 주최한다.'],
                                                 ['Persephone',
                                                  '인간',
                                                  '1년차 여름 24일',
                                                  '조카들과 함께 이사 온 호기심 많은 인간.'],
                                                 ['Jada',
                                                  '인간',
                                                  'Persephone 퀘스트 진행 시',
                                                  '열정적인 유물 수집가. 게임 후반에 해금.'],
                                                 ['Winston',
                                                  '인간',
                                                  'Persephone 퀘스트 진행 시',
                                                  '초자연 존재를 몹시 두려워함. 두려움과 맞서는 이야기.'],
                                                 ['Saga',
                                                  '늑대인간',
                                                  '1년차 봄 1일',
                                                  'Orlock과 아버지 Brook 사이의 갈등을 풀려고 애쓴다.'],
                                                 ['Ridge',
                                                  '늑대인간',
                                                  '1년차 봄 1일',
                                                  'Brook의 느긋한 동생. Howling Hammer를 운영하고 Ludo의 아버지.'],
                                                 ['Ludo', '늑대인간', '1년차 봄 1일', '근심 없는 장난꾸러기. 항상 Brook에게 혼난다.'],
                                                 ['Dragan',
                                                  '예언자',
                                                  '1년차 봄 1일',
                                                  '예지로 괴로워하며 카드 게임(Nokturna)을 갈고닦는다.'],
                                                 ['Alina', '예언자', '1년차 봄 1일', '강렬하고 열정적. Dragan에게 인내심이 없다.'],
                                                 ['Aras',
                                                  '예언자',
                                                  '1년차 봄 1일',
                                                  '패션점 Third Eye Threads를 운영. 친절하고 말이 부드럽다.'],
                                                 ['Death', '초자연 존재', '스토리 진행 시', '일에 지쳐 있음. 도와주면 다정해진다.'],
                                                 ['Llemi', '초자연 존재', '봄, Lovage 축제 전', '사랑의 악마. 모든 만남이 인상적.'],
                                                 ['Kim', '인어', '숨김(미정)', '비밀 연애 후보.'],
                                                 ['Tae', '인어', '숨김(미정)', '비밀 연애 후보.'],
                                                 ['Rei', '인어', '숨김(미정)', '비밀 연애 후보.']]}},
                             'fr': {0: {'rows': [['Fiona',
                                                  'Sorcière',
                                                  'Printemps 1, an 1',
                                                  'Distante et indifférente au début ; en conflit avec '
                                                  'Orlock, mais cache une histoire plus profonde.'],
                                                 ['Noel',
                                                  'Sorcière',
                                                  'Printemps 1, an 1',
                                                  'Arrogant, égoïste, préfère la pêche — son côté hautain '
                                                  'cache des insécurités.'],
                                                 ['Sabrina',
                                                  'Sorcière',
                                                  'Printemps 1, an 1',
                                                  'Sorcière dévouée, intelligente, parfois dépassée par sa '
                                                  'famille.'],
                                                 ['Luna',
                                                  'Sorcière',
                                                  'Printemps 1, an 1',
                                                  'Énigmatique, passe du temps dans son jardin ; en sait '
                                                  'beaucoup sur la magie.'],
                                                 ['Orlock',
                                                  'Vampire',
                                                  'Printemps 1, an 1',
                                                  "Vampire tourmenté par l'alcool ; un côté romantique et "
                                                  "brut s'épanouit à mesure qu'il guérit."],
                                                 ['Evan',
                                                  'Vampire',
                                                  'Printemps 1, an 1',
                                                  "Enfant décontracté d'Orlock ; souffre de la spirale "
                                                  "d'Orlock."],
                                                 ['Mina',
                                                  'Vampire',
                                                  'Printemps 1, an 1',
                                                  "Vive et enthousiaste, l'autre enfant d'Orlock et sœur "
                                                  "d'Evan ; s'inquiète pour sa famille."],
                                                 ['Samael',
                                                  'Vampire',
                                                  'Printemps 1, an 1',
                                                  "Neveu d'Orlock ; sombre, mystérieux et gentil."],
                                                 ['Elvira',
                                                  'Vampire',
                                                  'Printemps 1, an 1',
                                                  "Pleine d'entrain et motivée ; organise toujours des "
                                                  'rassemblements.'],
                                                 ['Persephone',
                                                  'Humaine',
                                                  'Été 24, an 1',
                                                  'Humaine curieuse venue avec sa nièce et son neveu.'],
                                                 ['Jada',
                                                  'Humaine',
                                                  'Quêtes de Persephone',
                                                  'Collectionneuse de reliques intense ; se débloque plus '
                                                  'tard.'],
                                                 ['Winston',
                                                  'Humain',
                                                  'Quêtes de Persephone',
                                                  "Terrifié par le surnaturel ; son arc parle d'affronter "
                                                  'ses peurs.'],
                                                 ['Saga',
                                                  'Loup-garou',
                                                  'Printemps 1, an 1',
                                                  "Tente d'apaiser la querelle entre Orlock et son père "
                                                  'Brook.'],
                                                 ['Ridge',
                                                  'Loup-garou',
                                                  'Printemps 1, an 1',
                                                  'Frère décontracté de Brook ; tient le Howling Hammer, '
                                                  'père de Ludo.'],
                                                 ['Ludo',
                                                  'Loup-garou',
                                                  'Printemps 1, an 1',
                                                  'Farceur insouciant, toujours en conflit avec Brook.'],
                                                 ['Dragan',
                                                  'Voyant',
                                                  'Printemps 1, an 1',
                                                  'Lutte avec ses visions ; perfectionne son jeu de cartes '
                                                  '(Nokturna).'],
                                                 ['Alina',
                                                  'Voyante',
                                                  'Printemps 1, an 1',
                                                  'Intense et passionnée ; peu de patience pour Dragan.'],
                                                 ['Aras',
                                                  'Voyant',
                                                  'Printemps 1, an 1',
                                                  'Tient la boutique Third Eye Threads ; gentil et doux.'],
                                                 ['Death',
                                                  'Surnaturel',
                                                  "Progression de l'histoire",
                                                  'Las de son travail ; attentionné une fois aidé.'],
                                                 ['Llemi',
                                                  'Surnaturel',
                                                  'Printemps, avant le festival Lovage',
                                                  "Un démon de l'amour ; chaque interaction est mémorable."],
                                                 ['Kim',
                                                  'Sirène',
                                                  'Caché (à confirmer)',
                                                  'Candidate romance secrète.'],
                                                 ['Tae',
                                                  'Sirène',
                                                  'Caché (à confirmer)',
                                                  'Candidate romance secrète.'],
                             ...
                             'de': {0: {'rows': [['Fiona',
                                                  'Hexe',
                                                  'Frühling 1, Jahr 1',
                                                  'Anfangs distanziert und desinteressiert; liegt mit Orlock '
                                                  'im Streit, verbirgt aber eine tiefere Geschichte.'],
                                                 ['Noel',
                                                  'Hexe',
                                                  'Frühling 1, Jahr 1',
                                                  'Arrogant, eigennützig, angelt am liebsten — seine '
                                                  'Hochmütigkeit verdeckt Unsicherheiten.'],
                                                 ['Sabrina',
                                                  'Hexe',
                                                  'Frühling 1, Jahr 1',
                                                  'Hingebungsvolle, kluge Hexe, manchmal von ihrer Familie '
                                                  'überfordert.'],
                                                 ['Luna',
                                                  'Hexe',
                                                  'Frühling 1, Jahr 1',
                                                  'Rätselhaft, verbringt Zeit in ihrem Garten; weiß viel '
                                                  'über Magie.'],
                                                 ['Orlock',
                                                  'Vampir',
                                                  'Frühling 1, Jahr 1',
                                                  'Geplagter Vampir mit Alkoholproblem; eine romantische, '
                                                  'rohe Seite blüht auf, während er sich erholt.'],
                                                 ['Evan',
                                                  'Vampir',
                                                  'Frühling 1, Jahr 1',
                                                  'Orlocks lässiges Kind; kämpft mit Orlocks Absturz.'],
                                                 ['Mina',
                                                  'Vampir',
                                                  'Frühling 1, Jahr 1',
                                                  'Fröhlich und aufgedreht, Orlocks anderes Kind und Evans '
                                                  'Schwester; sorgt sich um die Familie.'],
                                                 ['Samael',
                                                  'Vampir',
                                                  'Frühling 1, Jahr 1',
                                                  'Orlocks Neffe; düster, geheimnisvoll und freundlich.'],
                                                 ['Elvira',
                                                  'Vampir',
                                                  'Frühling 1, Jahr 1',
                                                  'Voll Energie und motiviert; organisiert ständig '
                                                  'Zusammenkünfte.'],
                                                 ['Persephone',
                                                  'Mensch',
                                                  'Sommer 24, Jahr 1',
                                                  'Neugieriger Mensch, der mit Nichte und Neffe herzog.'],
                                                 ['Jada',
                                                  'Mensch',
                                                  'Mit Persephones Quests',
                                                  'Intensive Reliktsammlerin; wird später freigeschaltet.'],
                                                 ['Winston',
                                                  'Mensch',
                                                  'Mit Persephones Quests',
                                                  'Hat Angst vor Übernatürlichem; sein Bogen dreht sich um '
                                                  'Ängste.'],
                                                 ['Saga',
                                                  'Werwolf',
                                                  'Frühling 1, Jahr 1',
                                                  'Versucht, den Streit zwischen Orlock und ihrem Vater '
                                                  'Brook zu schlichten.'],
                                                 ['Ridge',
                                                  'Werwolf',
                                                  'Frühling 1, Jahr 1',
                                                  'Brooks lässiger Bruder; führt den Howling Hammer, Vater '
                                                  'von Ludo.'],
                                                 ['Ludo',
                                                  'Werwolf',
                                                  'Frühling 1, Jahr 1',
                                                  'Sorgloser Streichespieler, ständig in Schwierigkeiten mit '
                                                  'Brook.'],
                                                 ['Dragan',
                                                  'Seher',
                                                  'Frühling 1, Jahr 1',
                                                  'Kämpft mit Visionen; perfektioniert sein Kartenspiel '
                                                  '(Nokturna).'],
                                                 ['Alina',
                                                  'Seherin',
                                                  'Frühling 1, Jahr 1',
                                                  'Intensiv und leidenschaftlich; wenig Geduld für Dragan.'],
                                                 ['Aras',
                                                  'Seher',
                                                  'Frühling 1, Jahr 1',
                                                  'Führt den Modeladen Third Eye Threads; freundlich und '
                                                  'leise.'],
                                                 ['Death',
                                                  'Übernaturwesen',
                                                  'Story-Fortschritt',
                                                  'Müde von seinem Job; fürsorglich, sobald man hilft.'],
                                                 ['Llemi',
                                                  'Übernaturwesen',
                                                  'Frühling, vor dem Lovage-Fest',
                                                  'Ein Liebesdämon; jede Begegnung bleibt in Erinnerung.'],
                                                 ['Kim',
                                                  'Meerjungfrau',
                                                  'Versteckt (offen)',
                                                  'Geheimer Romantik-Kandidat.'],
                                                 ['Tae',
                                                  'Meerjungfrau',
                                                  'Versteckt (offen)',
                                                  'Geheimer Romantik-Kandidat.'],
                                                 ['Rei',
                                                  ...
                                                  'Versteckt (offen)',
                                                  'Geheimer Romantik-Kandidat.']]}}},
 'moonlight-peaks/fishing': {'ja': {1: {'rows': [['Whisper',
                                                  'コモン',
                                                  '大部分の水域（Silverveil Lake を除く）',
                                                  '全季節 / いつでも / どんな天候でも',
                                                  '任意の釣り竿',
                                                  '6',
                                                  '40'],
                                                 ...
                                                 ['Goldy',
                                                  'アンコモン',
                                                  'Silverveil 付近・農場・Misty Shores の川',
                                                  '春・夏のみ',
                                                  '任意の釣り竿',
                                                  '8',
                                                  '50'],
                                                 ...
                                                 ['Leftsee',
                                                  'アンコモン',
                                                  '地下 / Cave of Echoes / Crystal Cave',
                                                  '全季節 / いつでも',
                                                  '任意の釣り竿',
                                                  '8',
                                                  '140'],
                                                 ['Skullfin',
                                                  ...
                                                  '—',
                                                  '未定'],
                                                 ['Twilight', 'アンコモン', 'Luna Bay', '夕方', '任意の釣り竿', '—', '未定'],
                                                 ['Moonflutter',
                                                  'レア',
                                                  'Luna Bay',
                                                  '満月のみ',
                                                  ...
                                                  '—',
                                                  '未定'],
                                                 ['Furybud', 'レア', 'Luna Bay', '大型魚', 'プレミアム釣り竿', '—', '未定'],
                                                 ['Goliath',
                                                  'レア',
                                                  'Moonlit Pines River',
                                                  '大型魚',
                                                 ...
                                                 ['Armour',
                                                  ...
                                                  '8',
                                                  '280'],
                                                 ['Missing', 'スーパーレア', '任意の釣り場', '任意', '任意の釣り竿', '—', '未定'],
                                                 ['他に4種', '—', '未定', '未定', '未定', '—', '未定']]},
                                    2: {'rows': [['Fishing Rod', '無料（Noel のクエスト）', '小型魚のみ。'],
                                                 ['Premium Fishing Rod',
                                                  '16,000 コイン + 釣り竿1本 + 金の延べ棒3本',
                                                  '大型魚と小型魚の両方を釣れる。'],
                                                 ['Enchanted Fishing Rod',
                                                  '未定',
                                                  '全魚を釣れ、釣りのスタミナ消費がなくなる（コミュニティ報告）。']]}},
                             'ko': {1: {'rows': [['Whisper',
                                                  '커먼',
                                                  '대부분의 물(Silverveil Lake 제외)',
                                                  '전 계절 / 언제든 / 어떤 날씨든',
                                                  '아무 낚싯대',
                                                  '6',
                                                  '40'],
                                                 ...
                                                 ['Goldy',
                                                  '언커먼',
                                                  'Silverveil 근처·농장·Misty Shores 강',
                                                  '봄·여름 한정',
                                                  '아무 낚싯대',
                                                  '8',
                                                  '50'],
                                                 ...
                                                 ['Leftsee',
                                                  '언커먼',
                                                  '지하 / Cave of Echoes / Crystal Cave',
                                                  '전 계절 / 언제든',
                                                  '아무 낚싯대',
                                                  '8',
                                                  '140'],
                                                 ['Skullfin',
                                                  ...
                                                  '—',
                                                  '미정'],
                                                 ['Twilight', '언커먼', 'Luna Bay', '초저녁', '아무 낚싯대', '—', '미정'],
                                                 ['Moonflutter',
                                                  '레어',
                                                  'Luna Bay',
                                                  '보름달 한정',
                                                 ...
                                                 ['Armour',
                                                  ...
                                                  '8',
                                                  '280'],
                                                 ['Missing', '슈퍼 레어', '아무 낚시터', '아무 때나', '아무 낚싯대', '—', '미정'],
                                                 ['추가 4종', '—', '미정', '미정', '미정', '—', '미정']]},
                                    2: {'rows': [['Fishing Rod', '무료(Noel의 퀘스트)', '소형 물고기만.'],
                                                 ['Premium Fishing Rod',
                                                  '16,000코인 + 낚싯대 1개 + 금괴 3개',
                                                  '대형·소형 물고기 모두 낚을 수 있음.'],
                                                 ['Enchanted Fishing Rod',
                                                  '미정',
                                                  '모든 물고기를 낚고 낚시 스태미나 소모를 없앰(커뮤니티 보고).']]}},
                             'fr': {1: {'rows': [['Whisper',
                                                  'Commun',
                                                  'La plupart des eaux (sauf Silverveil Lake)',
                                                  'Toutes saisons / toute heure / toute météo',
                                                  'Toute canne',
                                                  '6',
                                                  '40'],
                                                 ['Splotch',
                                                 ...
                                                 ['Glibby',
                                                  'Peu commun',
                                                  'Rivières près de Silverveil / votre ferme',
                                                  'Toutes saisons / toute heure',
                                                  'Toute canne',
                                                  '8',
                                                  '65'],
                                                 ...
                                                 ['Goldy',
                                                  'Peu commun',
                                                  'Rivières près de Silverveil / ferme / Misty Shores',
                                                  'Printemps et été uniquement',
                                                  'Toute canne',
                                                  '8',
                                                  '50'],
                                                 ['Mouthout',
                                                 ...
                                                 ['Leftsee',
                                                  'Peu commun',
                                                  'Souterrain / Cave of Echoes / Crystal Cave',
                                                  'Toutes saisons / toute heure',
                                                  'Toute canne',
                                                  '8',
                                                  '140'],
                                                 ...
                                                 ['4 espèces de plus',
                                                  ...
                                                  'à compléter']]},
                                    2: {'rows': [['Fishing Rod',
                                                  'Gratuit (quête de Noel)',
                                                  'Petits poissons uniquement.'],
                                                 ['Premium Fishing Rod',
                                                  "16 000 pièces + 1x canne + 3x lingot d'or",
                                                  'Attrape gros et petits poissons.'],
                                                 ['Enchanted Fishing Rod',
                                                  'à compléter',
                                                  "Attrape tous les poissons et supprime le coût d'énergie "
                                                  'de la pêche (selon la communauté).']]}},
                             'de': {1: {'rows': [['Whisper',
                                                  'Häufig',
                                                  'Die meisten Gewässer (außer Silverveil Lake)',
                                                  'Alle Jahreszeiten / jederzeit / jedes Wetter',
                                                  'Jede Rute',
                                                  '6',
                                                  '40'],
                                                 ['Splotch',
                                                 ...
                                                 ['Glibby',
                                                  'Ungewöhnlich',
                                                  'Flüsse bei Silverveil / deine Farm',
                                                  'Alle Jahreszeiten / jederzeit',
                                                  'Jede Rute',
                                                  '8',
                                                  '65'],
                                                 ...
                                                 ['Goldy',
                                                  'Ungewöhnlich',
                                                  'Flüsse bei Silverveil / Farm / Misty Shores',
                                                  'Nur Frühling & Sommer',
                                                  'Jede Rute',
                                                  '8',
                                                  '50'],
                                                 ...
                                                 ['Leftsee',
                                                  'Ungewöhnlich',
                                                  'Unterirdisch / Cave of Echoes / Crystal Cave',
                                                  'Alle Jahreszeiten / jederzeit',
                                                  'Jede Rute',
                                                  '8',
                                                  '140'],
                                                 ...
                                                 ['4 weitere Arten',
                                                  ...
                                                  'offen']]},
                                    2: {'rows': [['Fishing Rod',
                                                  'Kostenlos (Noels Quest)',
                                                  'Nur kleine Fische.'],
                                                 ['Premium Fishing Rod',
                                                  '16.000 Münzen + 1x Angelrute + 3x Goldbarren',
                                                  'Fängt große und kleine Fische.'],
                                                 ['Enchanted Fishing Rod',
                                                  'offen',
                                                  'Fängt jeden Fisch und entfernt die Energiekosten des '
                                                  'Angelns (laut Community-Berichten).']]}}},
 'moonlight-peaks/flowers': {'ja': {0: {'rows': [['Black Azalea',
                                                  '夏',
                                                  'Misty Shores、Moonlit Pines',
                                                  '6',
                                                  'Death（大好物）、Luna（大好物）'],
                                                 ['Blue Azalea', '—', '—', '6', 'Luna（大好物）、Winston'],
                                                 ['Pink Azalea',
                                                  '春',
                                                  '自分の農場、Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['Purple Azalea',
                                                  ...
                                                  '自分の農場、Moonlit Pines',
                                                  '6',
                                                  'Luna（大好物）、Sabrina（大好物）'],
                                                 ['Red Azalea', '春', 'Misty Shores', '6', 'Luna（大好物）'],
                                                 ['Yellow Azalea',
                                                  '春',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Jada（大好物）、Luna（大好物）'],
                                                 ['Blue Kthonia', '—', '—', '15', 'Luna（大好物）'],
                                                 ['Purple Kthonia',
                                                  '春・夏',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna（大好物）、Sabrina（大好物）、Saga（大好物）'],
                                                 ['Purple Lavender',
                                                  '春',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna（大好物）、Persephone（大好物）'],
                                                 ['Red Lavender', '春', 'Misty Shores', '15', 'Luna（大好物）'],
                                                 ['Blue Moonlight Flower',
                                                  '春',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Luna（大好物）、Moon Goddess（大好物）'],
                                                 ['Purple Moonlight Flower',
                                                  '夏',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Aras（大好物）、Dragan（大好物）、Luna（大好物）、Moon Goddess（大好物）'],
                                                 ['Black Plumeria', '—', '—', '6', 'Luna（大好物）'],
                                                 ['Blue Plumeria', '—', '—', '6', 'Luna（大好物）'],
                                                 ['Pink Plumeria', '—', '—', '6', 'Luna（大好物）'],
                                                 ['Purple Plumeria',
                                                  '春・夏',
                                                  '自分の農場、Moonlit Pines',
                                                  '6',
                                                  'Luna（大好物）、Sabrina（大好物）'],
                                                 ['Red Plumeria', '—', '—', '6', 'Luna（大好物）'],
                                                 ['Yellow Plumeria',
                                                  '春',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna（大好物）、Sun God（大好物）'],
                                                 ['Poinsettia', '冬', 'Misty Shores', '—', 'Luna（大好物）'],
                                                 ['Black Rose',
                                                  '夏',
                                                  'Khazan Temple',
                                                  '10',
                                                 ...
                                                 ['Blue Rose',
                                                  ...
                                                  '10',
                                                  'Luna（大好物）、Ridge（大好物）'],
                                                 ['Pink Rose', '—', '—', '10', 'Luna（大好物）'],
                                                 ['Purple Rose',
                                                  '春・夏',
                                                  'Moonlit Pines、自分の農場',
                                                  '10',
                                                  'Luna（大好物）'],
                                                 ['Red Rose', '—', '—', '10', 'Elvira（大好物）、Luna（大好物）'],
                                                 ['White Rose',
                                                  '春・夏',
                                                  'Khazan Temple、Moonlit Pines',
                                                  '10',
                                                  'Brook（大好物）、Luna（大好物）'],
                                                 ['Yellow Rose', '春', 'Howling Marshes', '10', 'Luna（大好物）'],
                                                 ['Black Tulips',
                                                  '春',
                                                  'Misty Shores',
                                                  '6',
                                                  'Ludo（大好物）、Luna（大好物）'],
                                                 ['Blue Tulips', '—', '—', '6', 'Luna（大好物）'],
                                                 ['Pink Tulips',
                                                  '春',
                                                  'Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['Purple Tulips',
                                                  ...
                                                  '6',
                                                  'Luna（大好物）、Sabrina（大好物）'],
                                                 ['Red Tulips', '春', 'Misty Shores', '6', 'Luna（大好物）'],
                                                 ['White Tulips',
                                                  '春',
                                                  'Crest Garden、町の北東',
                                                  '6',
                                                 ...
                                                 ['Yellow Tulips',
                                                  ...
                                                  '6',
                                                  'Luna（大好物）']]}},
                             'ko': {0: {'rows': [['Black Azalea',
                                                  '여름',
                                                  'Misty Shores, Moonlit Pines',
                                                  '6',
                                                  'Death (최애), Luna (최애)'],
                                                 ['Blue Azalea', '—', '—', '6', 'Luna (최애), Winston'],
                                                 ['Pink Azalea',
                                                  '봄',
                                                  '내 농장, Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['Purple Azalea',
                                                  ...
                                                  '6',
                                                  'Luna (최애), Sabrina (최애)'],
                                                 ['Red Azalea', '봄', 'Misty Shores', '6', 'Luna (최애)'],
                                                 ['Yellow Azalea',
                                                  '봄',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Jada (최애), Luna (최애)'],
                                                 ['Blue Kthonia', '—', '—', '15', 'Luna (최애)'],
                                                 ['Purple Kthonia',
                                                  '봄·여름',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (최애), Sabrina (최애), Saga (최애)'],
                                                 ['Purple Lavender',
                                                  '봄',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (최애), Persephone (최애)'],
                                                 ['Red Lavender', '봄', 'Misty Shores', '15', 'Luna (최애)'],
                                                 ['Blue Moonlight Flower',
                                                  '봄',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Luna (최애), Moon Goddess (최애)'],
                                                 ['Purple Moonlight Flower',
                                                  '여름',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Aras (최애), Dragan (최애), Luna (최애), Moon Goddess (최애)'],
                                                 ['Black Plumeria', '—', '—', '6', 'Luna (최애)'],
                                                 ['Blue Plumeria', '—', '—', '6', 'Luna (최애)'],
                                                 ['Pink Plumeria', '—', '—', '6', 'Luna (최애)'],
                                                 ['Purple Plumeria',
                                                  '봄·여름',
                                                  '내 농장, Moonlit Pines',
                                                  '6',
                                                  'Luna (최애), Sabrina (최애)'],
                                                 ['Red Plumeria', '—', '—', '6', 'Luna (최애)'],
                                                 ['Yellow Plumeria',
                                                  '봄',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna (최애), Sun God (최애)'],
                                                 ['Poinsettia', '겨울', 'Misty Shores', '—', 'Luna (최애)'],
                                                 ['Black Rose',
                                                  '여름',
                                                  'Khazan Temple',
                                                  '10',
                                                 ...
                                                 ['Blue Rose',
                                                  ...
                                                  '10',
                                                  'Luna (최애), Ridge (최애)'],
                                                 ['Pink Rose', '—', '—', '10', 'Luna (최애)'],
                                                 ['Purple Rose',
                                                  '봄·여름',
                                                  'Moonlit Pines, 내 농장',
                                                  '10',
                                                  'Luna (최애)'],
                                                 ['Red Rose', '—', '—', '10', 'Elvira (최애), Luna (최애)'],
                                                 ['White Rose',
                                                  '봄·여름',
                                                  'Khazan Temple, Moonlit Pines',
                                                  '10',
                                                  'Brook (최애), Luna (최애)'],
                                                 ['Yellow Rose', '봄', 'Howling Marshes', '10', 'Luna (최애)'],
                                                 ['Black Tulips',
                                                  '봄',
                                                  'Misty Shores',
                                                  '6',
                                                  'Ludo (최애), Luna (최애)'],
                                                 ['Blue Tulips', '—', '—', '6', 'Luna (최애)'],
                                                 ['Pink Tulips',
                                                  '봄',
                                                  'Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['Purple Tulips',
                                                  ...
                                                  '6',
                                                  'Luna (최애), Sabrina (최애)'],
                                                 ['Red Tulips', '봄', 'Misty Shores', '6', 'Luna (최애)'],
                                                 ['White Tulips',
                                                  '봄',
                                                  'Crest Garden, 마을 북동쪽',
                                                  '6',
                                                 ...
                                                 ['Yellow Tulips',
                                                  ...
                                                  '6',
                                                  'Luna (최애)']]}},
                             'fr': {0: {'rows': [['Black Azalea',
                                                  'Été',
                                                  'Misty Shores, Moonlit Pines',
                                                  '6',
                                                  'Death (adoré), Luna (adoré)'],
                                                 ['Blue Azalea', '—', '—', '6', 'Luna (adoré), Winston'],
                                                 ['Pink Azalea',
                                                  'Printemps',
                                                  'Votre ferme, Moonlit Pines',
                                                  '6',
                                                  'Luna (adoré), Mina (adoré)'],
                                                 ['Purple Azalea',
                                                  'Printemps',
                                                  'Votre ferme, Moonlit Pines',
                                                  '6',
                                                  'Luna (adoré), Sabrina (adoré)'],
                                                 ['Red Azalea',
                                                  'Printemps',
                                                  'Misty Shores',
                                                  '6',
                                                 ...
                                                 ['Yellow Azalea',
                                                  ...
                                                  'Howling Marshes',
                                                  '6',
                                                  'Jada (adoré), Luna (adoré)'],
                                                 ['Blue Kthonia', '—', '—', '15', 'Luna (adoré)'],
                                                 ['Purple Kthonia',
                                                  'Printemps/Été',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (adoré), Sabrina (adoré), Saga (adoré)'],
                                                 ['Purple Lavender',
                                                  'Printemps',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (adoré), Persephone (adoré)'],
                                                 ['Red Lavender',
                                                  'Printemps',
                                                  'Misty Shores',
                                                  '15',
                                                 ...
                                                 ['Blue Moonlight Flower',
                                                  ...
                                                  'Khazan Temple',
                                                  '—',
                                                  'Luna (adoré), Moon Goddess (adoré)'],
                                                 ['Purple Moonlight Flower',
                                                  'Été',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Aras (adoré), Dragan (adoré), Luna (adoré), Moon Goddess '
                                                  '(adoré)'],
                                                 ['Black Plumeria', '—', '—', '6', 'Luna (adoré)'],
                                                 ['Blue Plumeria', '—', '—', '6', 'Luna (adoré)'],
                                                 ['Pink Plumeria', '—', '—', '6', 'Luna (adoré)'],
                                                 ['Purple Plumeria',
                                                  'Printemps/Été',
                                                  'Votre ferme, Moonlit Pines',
                                                  '6',
                                                  'Luna (adoré), Sabrina (adoré)'],
                                                 ['Red Plumeria', '—', '—', '6', 'Luna (adoré)'],
                                                 ['Yellow Plumeria',
                                                  'Printemps',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna (adoré), Sun God (adoré)'],
                                                 ['Poinsettia', 'Hiver', 'Misty Shores', '—', 'Luna (adoré)'],
                                                 ['Black Rose',
                                                  'Été',
                                                  'Khazan Temple',
                                                  '10',
                                                  'Alina (adoré), Luna (adoré)'],
                                                 ['Blue Rose',
                                                  'Été',
                                                  'Khazan Temple',
                                                  '10',
                                                  'Luna (adoré), Ridge (adoré)'],
                                                 ['Pink Rose', '—', '—', '10', 'Luna (adoré)'],
                                                 ['Purple Rose',
                                                  'Printemps/Été',
                                                  'Moonlit Pines, votre ferme',
                                                  '10',
                                                  'Luna (adoré)'],
                                                 ['Red Rose', '—', '—', '10', 'Elvira (adoré), Luna (adoré)'],
                                                 ['White Rose',
                                                  'Printemps/Été',
                                                  'Khazan Temple, Moonlit Pines',
                                                  '10',
                                                  'Brook (adoré), Luna (adoré)'],
                                                 ['Yellow Rose',
                                                  'Printemps',
                                                  'Howling Marshes',
                                                  '10',
                                                 ...
                                                 ['Black Tulips',
                                                  ...
                                                  'Misty Shores',
                                                  '6',
                                                  'Ludo (adoré), Luna (adoré)'],
                                                 ['Blue Tulips', '—', '—', '6', 'Luna (adoré)'],
                                                 ['Pink Tulips',
                                                  'Printemps',
                                                  'Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['White Tulips',
                                                  'Printemps',
                                                  'Crest Garden, ville NE',
                                                  '6',
                                                  'Fiona (adoré), Luna (adoré)'],
                                                 ['Yellow Tulips',
                                                  'Printemps',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna (adoré)']]}},
                             'de': {0: {'rows': [['Black Azalea',
                                                  'Sommer',
                                                  'Misty Shores, Moonlit Pines',
                                                  '6',
                                                  'Death (geliebt), Luna (geliebt)'],
                                                 ['Blue Azalea', '—', '—', '6', 'Luna (geliebt), Winston'],
                                                 ['Pink Azalea',
                                                  'Frühling',
                                                  'Deine Farm, Moonlit Pines',
                                                  '6',
                                                  'Luna (geliebt), Mina (geliebt)'],
                                                 ['Purple Azalea',
                                                  'Frühling',
                                                  'Deine Farm, Moonlit Pines',
                                                  '6',
                                                  'Luna (geliebt), Sabrina (geliebt)'],
                                                 ['Red Azalea',
                                                  'Frühling',
                                                  'Misty Shores',
                                                  '6',
                                                 ...
                                                 ['Yellow Azalea',
                                                  ...
                                                  'Howling Marshes',
                                                  '6',
                                                  'Jada (geliebt), Luna (geliebt)'],
                                                 ['Blue Kthonia', '—', '—', '15', 'Luna (geliebt)'],
                                                 ['Purple Kthonia',
                                                  'Frühling/Sommer',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (geliebt), Sabrina (geliebt), Saga (geliebt)'],
                                                 ['Purple Lavender',
                                                  'Frühling',
                                                  'Moonlit Pines',
                                                  '15',
                                                  'Luna (geliebt), Persephone (geliebt)'],
                                                 ['Red Lavender',
                                                  'Frühling',
                                                  'Misty Shores',
                                                  '15',
                                                 ...
                                                 ['Blue Moonlight Flower',
                                                  ...
                                                  'Khazan Temple',
                                                  '—',
                                                  'Luna (geliebt), Moon Goddess (geliebt)'],
                                                 ['Purple Moonlight Flower',
                                                  'Sommer',
                                                  'Khazan Temple',
                                                  '—',
                                                  'Aras (geliebt), Dragan (geliebt), Luna (geliebt), Moon '
                                                  'Goddess (geliebt)'],
                                                 ['Black Plumeria', '—', '—', '6', 'Luna (geliebt)'],
                                                 ['Blue Plumeria', '—', '—', '6', 'Luna (geliebt)'],
                                                 ['Pink Plumeria', '—', '—', '6', 'Luna (geliebt)'],
                                                 ['Purple Plumeria',
                                                  'Frühling/Sommer',
                                                  'Deine Farm, Moonlit Pines',
                                                  '6',
                                                  'Luna (geliebt), Sabrina (geliebt)'],
                                                 ['Red Plumeria', '—', '—', '6', 'Luna (geliebt)'],
                                                 ['Yellow Plumeria',
                                                  'Frühling',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna (geliebt), Sun God (geliebt)'],
                                                 ['Poinsettia',
                                                  'Winter',
                                                  'Misty Shores',
                                                  '—',
                                                 ...
                                                 ['Black Rose',
                                                  ...
                                                  'Khazan Temple',
                                                  '10',
                                                  'Alina (geliebt), Luna (geliebt)'],
                                                 ['Blue Rose',
                                                  'Sommer',
                                                  'Khazan Temple',
                                                  '10',
                                                  'Luna (geliebt), Ridge (geliebt)'],
                                                 ['Pink Rose', '—', '—', '10', 'Luna (geliebt)'],
                                                 ['Purple Rose',
                                                  'Frühling/Sommer',
                                                  'Moonlit Pines, deine Farm',
                                                  '10',
                                                  'Luna (geliebt)'],
                                                 ['Red Rose',
                                                  '—',
                                                  '—',
                                                  '10',
                                                  'Elvira (geliebt), Luna (geliebt)'],
                                                 ['White Rose',
                                                  'Frühling/Sommer',
                                                  'Khazan Temple, Moonlit Pines',
                                                  '10',
                                                  'Brook (geliebt), Luna (geliebt)'],
                                                 ['Yellow Rose',
                                                  'Frühling',
                                                  'Howling Marshes',
                                                  '10',
                                                 ...
                                                 ['Black Tulips',
                                                  ...
                                                  'Misty Shores',
                                                  '6',
                                                  'Ludo (geliebt), Luna (geliebt)'],
                                                 ['Blue Tulips', '—', '—', '6', 'Luna (geliebt)'],
                                                 ['Pink Tulips',
                                                  'Frühling',
                                                  'Moonlit Pines',
                                                  '6',
                                                 ...
                                                 ['White Tulips',
                                                  'Frühling',
                                                  'Crest Garden, Stadt NO',
                                                  '6',
                                                  'Fiona (geliebt), Luna (geliebt)'],
                                                 ['Yellow Tulips',
                                                  'Frühling',
                                                  'Howling Marshes',
                                                  '6',
                                                  'Luna (geliebt)']]}}},
 'moonlight-peaks/spells': {'ja': {0: {'rows': [['Aquaflux I',
                                                 '無料（ストーリー）',
                                                 '最大16マスの作物に水をやるじょうろを召喚する。',
                                                 '1 マナ'],
                                                ['Aquaflux II',
                                                 '8,000 コイン（魔女の杖が必要）',
                                                 'じょうろを2つ召喚し、それぞれ最大24マスに水をやる。',
                                                 '1 マナ'],
                                                ['Arborascend I', '1,200 コイン', '木を1本魔法で移動する。', '2 マナ'],
                                                ['Ethereal Hands I',
                                                 '1,400 コイン',
                                                 '最大32マスの作物を収穫する手を召喚する。',
                                                 '1 マナ'],
                                                ['Metamorphosia I',
                                                 '1,600 コイン',
                                                 '作物1つをランダムな別の作物に変える。',
                                                 '3 マナ'],
                                                ['Hoisthaven', '2,000 コイン', '建物を魔法で移動する。', '3 マナ'],
                                                ['Maturio I', '2,000 コイン', '1×1マスの作物を一瞬で成熟させる。', '2 マナ'],
                                                ['Refilliarmus', '2,000 コイン', 'じょうろを一瞬で満たす。', '0 マナ'],
                                                ['Ethereal Shovels I',
                                                 '2,200 コイン',
                                                 '最大32スポットを掘るシャベルを召喚する。',
                                                 '1 マナ'],
                                                ['Ethereal Axes I',
                                                 '2,400 コイン',
                                                 '最大16本の丸太や木を切る斧を召喚する。',
                                                ...
                                                ['Ethereal Pickaxes I',
                                                 ...
                                                 '最大16個の岩を砕くつるはしを召喚する。',
                                                 '2 マナ'],
                                                ["Tomorrow's Tears", '4,000 コイン', '次の夜に雨を降らせる。', '3 マナ']]}},
                            'ko': {0: {'rows': [['Aquaflux I',
                                                 '무료(스토리)',
                                                 '최대 16칸의 작물에 물을 주는 물뿌리개를 소환.',
                                                 '1 마나'],
                                                ['Aquaflux II',
                                                 '8,000코인(마녀의 지팡이 필요)',
                                                 '물뿌리개 2개를 소환, 각각 최대 24칸.',
                                                 '1 마나'],
                                                ['Arborascend I', '1,200코인', '나무 1그루를 마법으로 이동.', '2 마나'],
                                                ['Ethereal Hands I',
                                                 '1,400코인',
                                                 '최대 32칸을 수확하는 도움의 손을 소환.',
                                                 '1 마나'],
                                                ['Metamorphosia I',
                                                 '1,600코인',
                                                 '작물 1개를 무작위 다른 작물로 변환.',
                                                 '3 마나'],
                                                ['Hoisthaven', '2,000코인', '건물을 마법으로 이동.', '3 마나'],
                                                ['Maturio I', '2,000코인', '1×1 구역의 작물을 즉시 성숙.', '2 마나'],
                                                ['Refilliarmus', '2,000코인', '물뿌리개를 즉시 가득 채움.', '0 마나'],
                                                ['Ethereal Shovels I',
                                                 '2,200코인',
                                                 '최대 32칸을 파는 삽을 소환.',
                                                 '1 마나'],
                                                ['Ethereal Axes I',
                                                 '2,400코인',
                                                 '최대 16개의 통나무나 나무를 베는 도끼를 소환.',
                                                 '2 마나'],
                                                ['Ethereal Pickaxes I',
                                                 '2,600코인',
                                                 '최대 16개의 바위를 부수는 곡괭이를 소환.',
                                                 '2 마나'],
                                                ["Tomorrow's Tears", '4,000코인', '다음 밤에 비가 내리게 함.', '3 마나']]}},
                            'fr': {0: {'rows': [['Aquaflux I',
                                                 'Gratuit (histoire)',
                                                 "Invoque un arrosoir qui arrose jusqu'à 16 cultures.",
                                                 '1 Mana'],
                                                ['Aquaflux II',
                                                 '8 000 pièces (nécessite la baguette de sorcière)',
                                                 "Invoque 2 arrosoirs, jusqu'à 24 cultures chacun.",
                                                 '1 Mana'],
                                                ['Arborascend I',
                                                 '1 200 pièces',
                                                 'Déplace magiquement 1 arbre.',
                                                 '2 Mana'],
                                                ['Ethereal Hands I',
                                                 '1 400 pièces',
                                                 "Invoque des mains qui récoltent jusqu'à 32 cultures.",
                                                 '1 Mana'],
                                                ['Metamorphosia I',
                                                 '1 600 pièces',
                                                 'Transforme 1 culture en une autre au hasard.',
                                                 '3 Mana'],
                                                ['Hoisthaven',
                                                 '2 000 pièces',
                                                 'Déplace magiquement un bâtiment.',
                                                 '3 Mana'],
                                                ['Maturio I',
                                                 '2 000 pièces',
                                                 'Fait mûrir instantanément les cultures sur une zone 1x1.',
                                                 '2 Mana'],
                                                ['Refilliarmus',
                                                 '2 000 pièces',
                                                 'Remplit instantanément votre arrosoir.',
                                                 '0 Mana'],
                                                ['Ethereal Shovels I',
                                                 '2 200 pièces',
                                                 "Invoque une pelle qui creuse jusqu'à 32 emplacements.",
                                                 '1 Mana'],
                                                ['Ethereal Axes I',
                                                 '2 400 pièces',
                                                 "Invoque une hache qui coupe jusqu'à 16 bûches ou arbres.",
                                                 '2 Mana'],
                                                ['Ethereal Pickaxes I',
                                                 '2 600 pièces',
                                                 "Invoque une pioche qui brise jusqu'à 16 rochers.",
                                                 '2 Mana'],
                                                ["Tomorrow's Tears",
                                                 '4 000 pièces',
                                                 'Fait pleuvoir la nuit suivante.',
                                                 '3 Mana']]}},
                            'de': {0: {'rows': [['Aquaflux I',
                                                 'Kostenlos (Story)',
                                                 'Beschwört eine Gießkanne, die bis zu 16 Pflanzen '
                                                 'bewässert.',
                                                 '1 Mana'],
                                                ['Aquaflux II',
                                                 '8.000 Münzen (benötigt Hexenstab)',
                                                 'Beschwört 2 Gießkannen, je bis zu 24 Pflanzen.',
                                                 '1 Mana'],
                                                ['Arborascend I',
                                                 '1.200 Münzen',
                                                 'Verschiebt 1 Baum magisch.',
                                                 '2 Mana'],
                                                ['Ethereal Hands I',
                                                 '1.400 Münzen',
                                                 'Beschwört helfende Hände, die bis zu 32 Pflanzen ernten.',
                                                 '1 Mana'],
                                                ['Metamorphosia I',
                                                 '1.600 Münzen',
                                                 'Verwandelt 1 Pflanze in eine andere zufällige Pflanze.',
                                                 '3 Mana'],
                                                ['Hoisthaven',
                                                 '2.000 Münzen',
                                                 'Verschiebt ein Gebäude magisch.',
                                                 '3 Mana'],
                                                ['Maturio I',
                                                 '2.000 Münzen',
                                                 'Lässt Pflanzen in einem 1x1-Bereich sofort reifen.',
                                                 '2 Mana'],
                                                ['Refilliarmus',
                                                 '2.000 Münzen',
                                                 'Füllt deine Gießkanne sofort auf.',
                                                 '0 Mana'],
                                                ['Ethereal Shovels I',
                                                 '2.200 Münzen',
                                                 'Beschwört eine Schaufel, die bis zu 32 Stellen gräbt.',
                                                 '1 Mana'],
                                                ['Ethereal Axes I',
                                                 '2.400 Münzen',
                                                 'Beschwört eine Axt, die bis zu 16 Stämme oder Bäume fällt.',
                                                 '2 Mana'],
                                                ['Ethereal Pickaxes I',
                                                 '2.600 Münzen',
                                                 'Beschwört eine Spitzhacke, die bis zu 16 Felsen '
                                                 'zertrümmert.',
                                                 '2 Mana'],
                                                ["Tomorrow's Tears",
                                                 '4.000 Münzen',
                                                 'Lässt es in der nächsten Nacht regnen.',
                                                 '3 Mana']]}}},
 'moonlight-peaks/achievements': {'ja': {0: {'rows': [['A Childhood Dream', 'Ridge と一緒に木の家を建てる。'],
                                                      ['A Farming Monopoly', '1,000,000 コインを稼ぐ。'],
                                                      ['A Generous Donor', '贈り物を299回する。'],
                                                      ['A House for the Hendersons', 'Henderson 一家を町に迎える。'],
                                                      ['A Lively Farm', '最初の農場の生き物を迎える。'],
                                                      ['A Magical Cocktail', 'すべてのポーション効果を同時に発動する。'],
                                                      ['A Magical Toolbelt', '任意の道具をエンチャント版に強化する。'],
                                                      ['AFKitten', 'Hellkitten を5分間連続で撫でる。'],
                                                      ["Albertus' Helper", '求人掲示板の依頼を25件こなす。'],
                                                      ['Archaeo-Logistics', '博物館を開く。'],
                                                      ['Awooooo!', '満月の夜に狼人と話す。'],
                                                      ['Back in Place', 'プラスチックの椅子をすべて戻す。'],
                                                      ['Back to the Den', 'Vampster をすべて巣に戻す。'],
                                                      ['Bad Santa!', 'Pakkeleg に木炭を持っていく。'],
                                                      ['Bottomless Chester', '一晩で9,000コイン以上の品物を売る。'],
                                                      ['Buddies for Afterlife', 'Death と友達になる。'],
                                                      ['By the Shore', 'Luna Bay を発見する。'],
                                                      ['Call of the Current', '人魚の姿を解放する。'],
                                                      ['Card Tricks', 'Nokturna の1試合で30点以上を取る。'],
                                                      ['Cartographer', 'Moonlight Peaks のすべての場所を発見する。'],
                                                      ['Do You Speak Animalese?', 'Hellkitten の姿で生き物と話す。'],
                                                      ['Dracula Estate', '家を完全にアップグレードする。'],
                                                      ['Fishing Pro', 'すべての魚を釣る。'],
                                                      ['Fully Energized', 'スタミナを最大まで上げる。'],
                                                      ['Get Creative', 'フラワーアレンジ・刺繍・花瓶のいずれかを作る。'],
                                                      ['Happy New Year!', 'ゲーム内の1年目を終える。'],
                                                      ['Magic at Max Capacity', 'マナを最大まで上げる。'],
                                                      ['Making Mina Proud', '25種類のレシピを料理する。'],
                                                      ['Master of Witchcraft', 'すべての呪文を完全に強化する。'],
                                                      ['Missing? No!', 'Missing を釣り上げる。'],
                                                      ['Moonlit Stretching', '初めてのヨガレッスンに参加する。'],
                                                      ['New Beginnings', '最初の作物を植える。'],
                                                      ['Nokturna Master', 'Nokturna のカードをすべて集める。'],
                                                      ['One Collection to Rule Them All', '博物館を完成させる。'],
                                                      ['Out of the Mist', 'Misty Shores の呪いを解く。'],
                                                      ['Out of This World', '月へ旅立つ。'],
                                                      ['Perpetual Bloom', '温室を建てる。'],
                                                      ['Purrgatory', 'Hellkitten の姿を解放する。'],
                                                      ['Raiders of the Lost Art', 'Elvira の宝探しを完了する。'],
                                                      ['Rightful Ritualist', 'すべての魔女のサークルを起動する。'],
                                                      ['Serial Gifter', '同じ夜に大好物の贈り物を25回する。'],
                                                      ['Skulls in a Net', 'Soul Blob をすべて集める。'],
                                                      ['Social Butterfly', '全キャラとハート4を達成する。'],
                                                      ['Soup-Chef', 'Mastersoup のトロフィーを獲得する。'],
                                                      ['Take a Seat', '壊れたベンチの修理を手伝う。'],
                                                      ['The Ambrosias', 'Ambrosia の紋章を Crest Garden に置く。'],
                                                      ['The Draculas', 'Dracula の紋章を Crest Garden に置く。'],
                                                      ['The Hendersons', 'Henderson の紋章を Crest Garden に置く。'],
                                                      ['The Hosus', 'Hosu の紋章を Crest Garden に置く。'],
                                                      ['The Khazans', 'Khazan の紋章を Crest Garden に置く。'],
                                                      ['The Logans', 'Logan の紋章を Crest Garden に置く。'],
                                                      ['The Pumpking', '謎のカボチャに出会う。'],
                                                      ['The Webbs', 'Webb の紋章を Crest Garden に置く。'],
                                                      ['Tied the Knot', '結婚する。'],
                                                      ['To the Depths', '地下墓地を開く。'],
                                                      ['Tree Hugger', '木と恋に落ちる。'],
                                                      ['Vampire with a Wand', '最初の呪文を唱える。'],
                                                      ['Wings of the Night', '蝙蝠の姿を解放する。'],
                                                      ['Witnessing Revolution', 'Draculambs の行進を見る。']]}},
                                  'ko': {0: {'rows': [['A Childhood Dream', 'Ridge와 함께 나무집 짓기.'],
                                                      ['A Farming Monopoly', '1,000,000코인 벌기.'],
                                                      ['A Generous Donor', '선물 299회 주기.'],
                                                      ['A House for the Hendersons',
                                                       'Henderson 가족을 마을에 맞이하기.'],
                                                      ['A Lively Farm', '첫 농장 생물 입양.'],
                                                      ['A Magical Cocktail', '모든 물약 효과를 동시에 활성화.'],
                                                      ['A Magical Toolbelt', '아무 도구나 마법 부여 버전으로 강화.'],
                                                      ['AFKitten', 'Hellkitten을 5분 연속 쓰다듬기.'],
                                                      ["Albertus' Helper", '일자리 게시판 의뢰 25개 완료.'],
                                                      ['Archaeo-Logistics', '박물관 개관.'],
                                                      ['Awooooo!', '보름달에 늑대인간과 대화.'],
                                                      ['Back in Place', '플라스틱 의자 전부 반납.'],
                                                      ['Back to the Den', 'Vampster 전부 굴로 돌려보내기.'],
                                                      ['Bad Santa!', 'Pakkeleg에게 숯 가져다주기.'],
                                                      ['Bottomless Chester', '하룻밤에 9,000코인어치 이상 판매.'],
                                                      ['Buddies for Afterlife', 'Death와 친구 되기.'],
                                                      ['By the Shore', 'Luna Bay 발견.'],
                                                      ['Call of the Current', '인어 형태 해금.'],
                                                      ['Card Tricks', 'Nokturna 한 판에서 30점 이상 획득.'],
                                                      ['Cartographer', 'Moonlight Peaks의 모든 장소 발견.'],
                                                      ['Do You Speak Animalese?', 'Hellkitten 형태로 생물과 대화.'],
                                                      ['Dracula Estate', '집 완전 업그레이드.'],
                                                      ['Fishing Pro', '모든 물고기 낚기.'],
                                                      ['Fully Energized', '스태미나 최대치 달성.'],
                                                      ['Get Creative', '꽃꽂이, 자수 또는 꽃병 제작.'],
                                                      ['Happy New Year!', '게임 내 첫해 완료.'],
                                                      ['Magic at Max Capacity', '마나 최대치 달성.'],
                                                      ['Making Mina Proud', '서로 다른 레시피 25개 요리.'],
                                                      ['Master of Witchcraft', '모든 주문 완전 강화.'],
                                                      ['Missing? No!', 'Missing 낚기.'],
                                                      ['Moonlit Stretching', '첫 요가 수업 참여.'],
                                                      ['New Beginnings', '첫 작물 심기.'],
                                                      ['Nokturna Master', 'Nokturna 카드 전부 수집.'],
                                                      ['One Collection to Rule Them All', '박물관 완성.'],
                                                      ['Out of the Mist', 'Misty Shores의 저주 풀기.'],
                                                      ['Out of This World', '달로 여행.'],
                                                      ['Perpetual Bloom', '온실 짓기.'],
                                                      ['Purrgatory', 'Hellkitten 형태 해금.'],
                                                      ['Raiders of the Lost Art', 'Elvira의 보물찾기 완료.'],
                                                      ['Rightful Ritualist', '모든 마녀의 원 활성화.'],
                                                      ['Serial Gifter', '같은 밤에 최애 선물 25개 주기.'],
                                                      ['Skulls in a Net', 'Soul Blob 전부 수집.'],
                                                      ['Social Butterfly', '모든 캐릭터와 하트 4개 달성.'],
                                                      ['Soup-Chef', 'Mastersoup 트로피 획득.'],
                                                      ['Take a Seat', '부서진 벤치 수리 돕기.'],
                                                      ['The Ambrosias', 'Ambrosia 문장을 Crest Garden에 배치.'],
                                                      ['The Draculas', 'Dracula 문장을 Crest Garden에 배치.'],
                                                      ['The Hendersons', 'Henderson 문장을 Crest Garden에 배치.'],
                                                      ['The Hosus', 'Hosu 문장을 Crest Garden에 배치.'],
                                                      ['The Khazans', 'Khazan 문장을 Crest Garden에 배치.'],
                                                      ['The Logans', 'Logan 문장을 Crest Garden에 배치.'],
                                                      ['The Pumpking', '수수께끼의 호박 만나기.'],
                                                      ['The Webbs', 'Webb 문장을 Crest Garden에 배치.'],
                                                      ['Tied the Knot', '결혼하기.'],
                                                      ['To the Depths', '지하 묘지 열기.'],
                                                      ['Tree Hugger', '나무와 사랑에 빠지기.'],
                                                      ['Vampire with a Wand', '첫 주문 시전.'],
                                                      ['Wings of the Night', '박쥐 형태 해금.'],
                                                      ['Witnessing Revolution', 'Draculambs의 행진 지켜보기.']]}},
                                  'fr': {0: {'rows': [['A Childhood Dream',
                                                       'Construire une cabane dans un arbre avec Ridge.'],
                                                      ['A Farming Monopoly', 'Gagner 1 000 000 pièces.'],
                                                      ['A Generous Donor', 'Offrir 299 cadeaux.'],
                                                      ['A House for the Hendersons',
                                                       'Accueillir la famille Henderson en ville.'],
                                                      ['A Lively Farm',
                                                       'Adopter sa première créature de ferme.'],
                                                      ['A Magical Cocktail',
                                                       'Avoir tous les effets de potions actifs en même '
                                                       'temps.'],
                                                      ['A Magical Toolbelt',
                                                       "Améliorer n'importe quel outil en version "
                                                       'enchantée.'],
                                                      ['AFKitten',
                                                       "Caresser votre Hellkitten cinq minutes d'affilée."],
                                                      ["Albertus' Helper",
                                                       'Terminer 25 demandes du tableau des missions.'],
                                                      ['Archaeo-Logistics', 'Ouvrir le musée.'],
                                                      ['Awooooo!',
                                                       'Parler à un loup-garou pendant une pleine lune.'],
                                                      ['Back in Place',
                                                       'Rendre toutes les chaises en plastique.'],
                                                      ['Back to the Den',
                                                       'Renvoyer chaque Vampster dans sa tanière.'],
                                                      ['Bad Santa!', 'Apporter du charbon à Pakkeleg.'],
                                                      ['Bottomless Chester',
                                                       "Vendre pour plus de 9 000 pièces d'objets en une "
                                                       'nuit.'],
                                                      ['Buddies for Afterlife', 'Devenir ami avec Death.'],
                                                      ['By the Shore', 'Découvrir Luna Bay.'],
                                                      ['Call of the Current', 'Débloquer la forme sirène.'],
                                                      ['Card Tricks',
                                                       'Marquer au moins 30 points en une partie de '
                                                       'Nokturna.'],
                                                      ['Cartographer',
                                                       'Découvrir chaque lieu de Moonlight Peaks.'],
                                                      ['Do You Speak Animalese?',
                                                       'Parler à une créature en forme Hellkitten.'],
                                                      ['Dracula Estate', 'Améliorer entièrement sa maison.'],
                                                      ['Fishing Pro', 'Attraper tous les poissons.'],
                                                      ['Fully Energized', "Atteindre l'énergie maximale."],
                                                      ['Get Creative',
                                                       'Fabriquer un arrangement floral, une broderie ou un '
                                                       'vase.'],
                                                      ['Happy New Year!',
                                                       'Terminer sa première année en jeu.'],
                                                      ['Magic at Max Capacity', 'Atteindre le mana maximal.'],
                                                      ['Making Mina Proud',
                                                       'Cuisiner 25 recettes différentes.'],
                                                      ['Master of Witchcraft',
                                                       'Améliorer entièrement chaque sort.'],
                                                      ['Missing? No!', 'Attraper un Missing.'],
                                                      ['Moonlit Stretching',
                                                       'Assister à sa première séance de yoga.'],
                                                      ['New Beginnings', 'Planter sa première culture.'],
                                                      ['Nokturna Master',
                                                       'Collecter toutes les cartes Nokturna.'],
                                                      ['One Collection to Rule Them All',
                                                       'Compléter le musée.'],
                                                      ['Out of the Mist',
                                                       'Lever la malédiction de Misty Shores.'],
                                                      ['Out of This World', 'Voyager vers la lune.'],
                                                      ['Perpetual Bloom', 'Construire une serre.'],
                                                      ['Purrgatory', 'Débloquer la forme Hellkitten.'],
                                                      ['Raiders of the Lost Art',
                                                       "Terminer la chasse au trésor d'Elvira."],
                                                      ['Rightful Ritualist',
                                                       'Activer chaque cercle de sorcière.'],
                                                      ['Serial Gifter',
                                                       'Offrir 25 cadeaux adorés la même nuit.'],
                                                      ['Skulls in a Net', 'Collecter chaque Soul Blob.'],
                                                      ['Social Butterfly',
                                                       'Atteindre quatre cœurs avec chaque personnage.'],
                                                      ['Soup-Chef', 'Gagner le trophée Mastersoup.'],
                                                      ['Take a Seat', 'Aider à réparer le banc cassé.'],
                                                      ['The Ambrosias',
                                                       "Placer l'emblème Ambrosia dans le Jardin des "
                                                       'emblèmes.'],
                                                      ['The Draculas',
                                                       "Placer l'emblème Dracula dans le Jardin des "
                                                       'emblèmes.'],
                                                      ['The Hendersons',
                                                       "Placer l'emblème Henderson dans le Jardin des "
                                                       'emblèmes.'],
                                                      ['The Hosus',
                                                       "Placer l'emblème Hosu dans le Jardin des emblèmes."],
                                                      ['The Khazans',
                                                       "Placer l'emblème Khazan dans le Jardin des "
                                                       'emblèmes.'],
                                                      ['The Logans',
                                                       "Placer l'emblème Logan dans le Jardin des emblèmes."],
                                                      ['The Pumpking',
                                                       'Rencontrer la citrouille mystérieuse.'],
                                                      ['The Webbs',
                                                       "Placer l'emblème Webb dans le Jardin des emblèmes."],
                                                      ['Tied the Knot', 'Se marier.'],
                                                      ['To the Depths', 'Ouvrir les Catacombes.'],
                                                      ['Tree Hugger', "Tomber amoureux d'un arbre."],
                                                      ['Vampire with a Wand', 'Lancer son premier sort.'],
                                                      ['Wings of the Night',
                                                       'Débloquer la forme chauve-souris.'],
                                                      ['Witnessing Revolution',
                                                       'Regarder la marche des Draculambs.']]}},
                                  'de': {0: {'rows': [['A Childhood Dream', 'Baue ein Baumhaus mit Ridge.'],
                                                      ['A Farming Monopoly', 'Verdiene 1.000.000 Münzen.'],
                                                      ['A Generous Donor', 'Verschenke 299 Geschenke.'],
                                                      ['A House for the Hendersons',
                                                       'Heiße die Familie Henderson in der Stadt '
                                                       'willkommen.'],
                                                      ['A Lively Farm', 'Nimm deine erste Farmkreatur auf.'],
                                                      ['A Magical Cocktail',
                                                       'Habe alle Trankeffekte gleichzeitig aktiv.'],
                                                      ['A Magical Toolbelt',
                                                       'Verbessere ein beliebiges Werkzeug zur verzauberten '
                                                       'Version.'],
                                                      ['AFKitten',
                                                       'Streichle dein Hellkitten fünf Minuten am Stück.'],
                                                      ["Albertus' Helper",
                                                       'Erledige 25 Aufträge vom Jobboard.'],
                                                      ['Archaeo-Logistics', 'Öffne das Museum.'],
                                                      ['Awooooo!', 'Sprich bei Vollmond mit einem Werwolf.'],
                                                      ['Back in Place', 'Gib alle Plastikstühle zurück.'],
                                                      ['Back to the Den',
                                                       'Bringe jeden Vampster in seine Höhle zurück.'],
                                                      ['Bad Santa!', 'Bringe Pakkeleg Holzkohle.'],
                                                      ['Bottomless Chester',
                                                       'Verkaufe in einer Nacht Gegenstände im Wert von über '
                                                       '9.000 Münzen.'],
                                                      ['Buddies for Afterlife', 'Freunde dich mit Death an.'],
                                                      ['By the Shore', 'Entdecke Luna Bay.'],
                                                      ['Call of the Current',
                                                       'Schalte die Meerjungfrauen-Form frei.'],
                                                      ['Card Tricks',
                                                       'Erziele mindestens 30 Punkte in einer '
                                                       'Nokturna-Partie.'],
                                                      ['Cartographer',
                                                       'Entdecke jeden Ort in Moonlight Peaks.'],
                                                      ['Do You Speak Animalese?',
                                                       'Sprich in Hellkitten-Form mit einer Kreatur.'],
                                                      ['Dracula Estate', 'Verbessere dein Haus vollständig.'],
                                                      ['Fishing Pro', 'Fange jeden Fisch.'],
                                                      ['Fully Energized', 'Erreiche maximale Energie.'],
                                                      ['Get Creative',
                                                       'Stelle ein Blumengesteck, eine Stickerei oder eine '
                                                       'Vase her.'],
                                                      ['Happy New Year!',
                                                       'Schließe dein erstes Spieljahr ab.'],
                                                      ['Magic at Max Capacity', 'Erreiche maximales Mana.'],
                                                      ['Making Mina Proud', 'Koche 25 verschiedene Rezepte.'],
                                                      ['Master of Witchcraft',
                                                       'Verbessere jeden Zauber vollständig.'],
                                                      ['Missing? No!', 'Fange ein Missing.'],
                                                      ['Moonlit Stretching',
                                                       'Nimm an deiner ersten Yogastunde teil.'],
                                                      ['New Beginnings', 'Pflanze deine erste Kultur an.'],
                                                      ['Nokturna Master', 'Sammle jede Nokturna-Karte.'],
                                                      ['One Collection to Rule Them All',
                                                       'Vervollständige das Museum.'],
                                                      ['Out of the Mist',
                                                       'Hebe den Fluch von Misty Shores auf.'],
                                                      ['Out of This World', 'Reise zum Mond.'],
                                                      ['Perpetual Bloom', 'Baue ein Gewächshaus.'],
                                                      ['Purrgatory', 'Schalte die Hellkitten-Form frei.'],
                                                      ['Raiders of the Lost Art',
                                                       'Schließe Elviras Schatzsuche ab.'],
                                                      ['Rightful Ritualist', 'Aktiviere jeden Hexenzirkel.'],
                                                      ['Serial Gifter',
                                                       'Verschenke 25 geliebte Geschenke in derselben '
                                                       'Nacht.'],
                                                      ['Skulls in a Net', 'Sammle jeden Soul Blob.'],
                                                      ['Social Butterfly',
                                                       'Erreiche vier Herzen bei jedem Charakter.'],
                                                      ['Soup-Chef', 'Gewinne die Mastersoup-Trophäe.'],
                                                      ['Take a Seat',
                                                       'Hilf, die kaputte Bank zu reparieren.'],
                                                      ['The Ambrosias',
                                                       'Platziere das Ambrosia-Wappen im Wappengarten.'],
                                                      ['The Draculas',
                                                       'Platziere das Dracula-Wappen im Wappengarten.'],
                                                      ['The Hendersons',
                                                       'Platziere das Henderson-Wappen im Wappengarten.'],
                                                      ['The Hosus',
                                                       'Platziere das Hosu-Wappen im Wappengarten.'],
                                                      ['The Khazans',
                                                       'Platziere das Khazan-Wappen im Wappengarten.'],
                                                      ['The Logans',
                                                       'Platziere das Logan-Wappen im Wappengarten.'],
                                                      ['The Pumpking', 'Triff den geheimnisvollen Kürbis.'],
                                                      ['The Webbs',
                                                       'Platziere das Webb-Wappen im Wappengarten.'],
                                                      ['Tied the Knot', 'Heirate.'],
                                                      ['To the Depths', 'Öffne die Katakomben.'],
                                                      ['Tree Hugger', 'Verliebe dich in einen Baum.'],
                                                      ['Vampire with a Wand', 'Wirke deinen ersten Zauber.'],
                                                      ['Wings of the Night',
                                                       'Schalte die Fledermaus-Form frei.'],
                                                      ['Witnessing Revolution',
                                                       'Sieh dem Marsch der Draculambs zu.']]}}},
 'moonlight-peaks/walkthrough': {'ja': {0: {'rows': [['第1部',
                                                      '住民との出会いと序盤',
                                                      'Orlock のワイン計画、町の人と出会う、釣り、最初の慰め、動物の世話、A Bridge Too '
                                                      'Far。'],
                                                     ['第2部',
                                                      '炉、魔法と猫変身',
                                                      'Crest Garden の緊張、A Croak and a Crest、晩餐会、虫取り、Magic of '
                                                      'Crops。'],
                                                     ['第3部',
                                                      'アップグレード、ハーブとマナ',
                                                      '鉄の入手、道具強化、素早く稼ぐ、着替え、ハーブ栽培、マナ回復。'],
                                                     ['第4部',
                                                      '博物館、Nokturna とポーション作り',
                                                      'A New Beginning、Museum in the Making、Nokturna '
                                                      'の勝ち方、博物館のキュレーション、Mend It With Magic。'],
                                                     ['第5部', 'Webb の紋章と人魚変身', 'Webb 家のストーリーと人魚の姿の解放。'],
                                                     ['第6部',
                                                      '蜂の巣、Saga と Kim のクエスト',
                                                      '蜂の巣、Saga のストーリー、Kim のクエスト。'],
                                                     ['第7部',
                                                      'Missing、月、蝙蝠と Khazan の紋章',
                                                      'Missing の魚、Selene と月、蝙蝠変身、Khazan の紋章、Master of the '
                                                      'Night、Pub Quiz。'],
                                                     ['第8部',
                                                      'Ambrosia、黄金と Dracula',
                                                      'Ambrosia の危機、黄金の入手場所、Darkness Over Moonlight '
                                                      'Peaks、クリア後の概観。']]}},
                                 'ko': {0: {'rows': [['1부',
                                                      '주민들과의 만남 & 시작',
                                                      'Orlock의 와인 계획, 마을 사람들 만나기, 낚시, 첫 위로, 동물 돌보기, A Bridge '
                                                      'Too Far.'],
                                                     ['2부',
                                                      '용광로, 마법 & 고양이 변신',
                                                      'Crest Garden의 긴장, A Croak and a Crest, 저녁 파티, 벌레 잡기, '
                                                      'Magic of Crops.'],
                                                     ['3부',
                                                      '강화, 허브 & 마나',
                                                      '철 얻기, 도구 강화, 빠르게 돈 벌기, 옷 갈아입기, 허브 재배, 마나 회복.'],
                                                     ['4부',
                                                      '박물관, Nokturna & 물약 제작',
                                                      'A New Beginning, Museum in the Making, Nokturna 이기는 '
                                                      '법, 박물관 큐레이팅, Mend It With Magic.'],
                                                     ['5부', 'Webb의 문장 & 인어 변신', 'Webb 가족 스토리와 인어 형태 해금.'],
                                                     ['6부', '벌통, Saga & Kim 퀘스트', '벌통, Saga의 스토리, Kim의 퀘스트.'],
                                                     ['7부',
                                                      'Missing, 달, 박쥐 & Khazan 문장',
                                                      'Missing 물고기, Selene과 달, 박쥐 변신, Khazan의 문장, Master of '
                                                      'the Night, Pub Quiz.'],
                                                     ['8부',
                                                      'Ambrosia, 금 & Dracula',
                                                      'Ambrosia 위기, 금 찾는 곳, Darkness Over Moonlight Peaks, '
                                                      '클리어 후 개요.']]}},
                                 'fr': {0: {'rows': [['Partie 1',
                                                      'Rencontres & démarrage',
                                                      "Le plan vin d'Orlock, rencontrer la ville, pêcher, "
                                                      'premier réconfort, soins aux animaux, A Bridge Too '
                                                      'Far.'],
                                                     ['Partie 2',
                                                      'Fournaise, magie & transformation en chat',
                                                      'Tension au Jardin des emblèmes, A Croak and a Crest, '
                                                      'dîner, attraper des insectes, Magic of Crops.'],
                                                     ['Partie 3',
                                                      'Améliorations, herbes & mana',
                                                      'Obtenir du fer, améliorer les outils, gagner de '
                                                      "l'argent vite, changer de vêtements, faire pousser "
                                                      'des herbes, récupérer du mana.'],
                                                     ['Partie 4',
                                                      'Musée, Nokturna & fabrication de potions',
                                                      'A New Beginning, Museum in the Making, comment gagner '
                                                      'à Nokturna, organiser le musée, Mend It With Magic.'],
                                                     ['Partie 5',
                                                      'Emblème Webb & transformation en sirène',
                                                      "L'histoire de la famille Webb et le déblocage de la "
                                                      'forme sirène.'],
                                                     ['Partie 6',
                                                      'Ruches, quêtes Saga & Kim',
                                                      "Les ruches, l'histoire de Saga et les quêtes de Kim."],
                                                     ['Partie 7',
                                                      'Missing, lune, chauve-souris & emblème Khazan',
                                                      'Le poisson Missing, Selene et la lune, transformation '
                                                      "en chauve-souris, l'emblème de Khazan, Master of the "
                                                      'Night, Pub Quiz.'],
                                                     ['Partie 8',
                                                      'Ambrosia, or & Dracula',
                                                      "La crise Ambrosia, où trouver de l'or, Darkness Over "
                                                      'Moonlight Peaks, aperçu post-jeu.']]}},
                                 'de': {0: {'rows': [['Teil 1',
                                                      'Bewohner treffen & Einstieg',
                                                      'Orlocks Weinplan, die Stadt kennenlernen, Fische '
                                                      'fangen, erster Trost, Tierpflege, A Bridge Too Far.'],
                                                     ['Teil 2',
                                                      'Schmelzofen, Magie & Katzen-Verwandlung',
                                                      'Spannung im Wappengarten, A Croak and a Crest, '
                                                      'Dinnerparty, Käfer fangen, Magic of Crops.'],
                                                     ['Teil 3',
                                                      'Upgrades, Kräuter & Mana',
                                                      'Eisen holen, Werkzeuge verbessern, schnell Geld '
                                                      'verdienen, Kleidung wechseln, Kräuter anbauen, Mana '
                                                      'wiederherstellen.'],
                                                     ['Teil 4',
                                                      'Museum, Nokturna & Trankbrauen',
                                                      'A New Beginning, Museum in the Making, wie man '
                                                      'Nokturna gewinnt, das Museum kuratieren, Mend It With '
                                                      'Magic.'],
                                                     ['Teil 5',
                                                      'Webb-Wappen & Meerjungfrauen-Verwandlung',
                                                      'Die Webb-Familiengeschichte und das Freischalten der '
                                                      'Meerjungfrauen-Form.'],
                                                     ['Teil 6',
                                                      'Bienenstöcke, Saga- & Kim-Quests',
                                                      'Bienenstöcke, Sagas Geschichte und Kims Quests.'],
                                                     ['Teil 7',
                                                      'Missing, Mond, Fledermaus & Khazan-Wappen',
                                                      'Der Missing-Fisch, Selene und der Mond, '
                                                      'Fledermaus-Verwandlung, Khazans Wappen, Master of the '
                                                      'Night, Pub Quiz.'],
                                                     ['Teil 8',
                                                      'Ambrosia, Gold & Dracula',
                                                      'Die Ambrosia-Krise, wo man Gold findet, Darkness Over '
                                                      'Moonlight Peaks, Überblick nach dem Spiel.']]}}},
 'moonlight-peaks/villagers': {'ja': {0: {'rows': [['Fiona',
                                                    '魔女',
                                                    '集会サークル / Webb of Wonders 周辺',
                                                    'Orlock と確執のある、よそよそしい魔女。'],
                                                   ['Noel', '魔女', '川と海岸', '傲慢な釣り魔女。表向きは高慢。'],
                                                   ['Sabrina',
                                                    '魔女',
                                                    'Webb of Wonders（魔法店）',
                                                    '呪文、マナ強化、インベントリスロットを販売。'],
                                                   ['Luna',
                                                    '魔女',
                                                    'Moonlit Pines の自分の農場 / 町役場のベンチ',
                                                    '種と動物を販売。どんな花も大好き。'],
                                                   ['Orlock',
                                                    '吸血鬼',
                                                    'Ambrosia Mansion / The Broken Lamp',
                                                    'アルコール問題から回復中の、苦悩する吸血鬼。'],
                                                   ['Evan', '吸血鬼', 'Coffee and Coffins', 'のんびり屋。Orlock の子。'],
                                                   ['Mina',
                                                    '吸血鬼',
                                                    'Coffee and Coffins',
                                                    '明るく興奮しやすい。Orlock のもう一人の子。'],
                                                   ['Samael',
                                                    '吸血鬼',
                                                    'The Broken Lamp（23:00以降）',
                                                    '陰があり、神秘的で優しい。'],
                                                   ['Elvira', '吸血鬼', '町中 / 交流イベントの企画', '元気なイベントのまとめ役。'],
                                                   ['Persephone',
                                                    '人間',
                                                    '1年目 夏24日に引っ越してくる',
                                                    '姪と甥を連れた好奇心旺盛な人間。'],
                                                   ['Jada',
                                                    ...
                                                    'Persephone のクエスト進行で',
                                                    '遺物収集家。博物館クエストラインを担当。'],
                                                   ['Winston', '人間', 'Persephone のクエスト進行で', '超自然的存在を怖がる。'],
                                                   ['Saga',
                                                    '狼人',
                                                    '町、Howling Marshes',
                                                    'Orlock と Brook の確執を和らげようとしている。'],
                                                   ['Ridge',
                                                    '狼人',
                                                    'The Howling Hammer（道具店）',
                                                    '道具のアップグレードを販売。Ludo の父。'],
                                                   ['Ludo', '狼人', '町中', '悪戯好きの狼人。'],
                                                   ['Dragan', '予言者', '自宅付近 / Nokturna', '予知に悩むカードプレイヤー。'],
                                                   ['Alina', '予言者', 'Dragan の家の近く', '情熱的で激しい予言者。'],
                                                   ['Aras',
                                                    '予言者',
                                                    'Third Eye Threads（ファッション）',
                                                    '優しく物腰の柔らかい店主。'],
                                                   ['Death', '超自然的存在', '地下墓地の近く', '仕事に疲れている。虫取り網をくれる。'],
                                                   ['Llemi', '超自然的存在', 'Lovage 祭りの前', '愛の悪魔。デート可能。'],
                                                   ['Kim / Tae / Rei', '人魚', '隠し', '隠し恋愛候補。'],
                                                   ['Viktor', 'NPC', 'ドームの建物', 'Red Wine クエストをくれる。チーズ好き。'],
                                                   ['Brook', 'NPC', '町役場 / 町長', '狼人の町長。あなたを登録する。'],
                                                   ['Jarvis', 'NPC', '町中（幽霊）', 'Chalice について教えてくれる。'],
                                                   ['Chester', 'NPC', '自分の農場', '出荷モンスター。']]}},
                               'ko': {0: {'rows': [['Fiona',
                                                    '마녀',
                                                    '집회 원형 / Webb of Wonders 주변',
                                                    'Orlock과 앙숙인 냉담한 마녀.'],
                                                   ['Noel', '마녀', '강가와 해안', '거만한 낚시 마녀. 겉으로는 오만.'],
                                                   ['Sabrina',
                                                    '마녀',
                                                    'Webb of Wonders(마법 상점)',
                                                    '주문, 마나 강화, 인벤토리 슬롯 판매.'],
                                                   ['Luna',
                                                    '마녀',
                                                    'Moonlit Pines의 자기 농장 / 마을 회관 벤치',
                                                    '씨앗과 동물 판매. 어떤 꽃이든 최애.'],
                                                   ['Orlock',
                                                    '뱀파이어',
                                                    'Ambrosia Mansion / The Broken Lamp',
                                                    '알코올 문제에서 회복 중인 고뇌하는 뱀파이어.'],
                                                   ['Evan', '뱀파이어', 'Coffee and Coffins', '느긋함. Orlock의 자식.'],
                                                   ['Mina',
                                                    '뱀파이어',
                                                    'Coffee and Coffins',
                                                    '밝고 활기참. Orlock의 또 다른 자식.'],
                                                   ['Samael',
                                                    '뱀파이어',
                                                    'The Broken Lamp(23:00 이후)',
                                                    '어둡고 신비로우며 친절함.'],
                                                   ['Elvira', '뱀파이어', '마을 곳곳 / 모임 주최', '활기찬 행사 주최자.'],
                                                   ['Persephone',
                                                    '인간',
                                                    '1년차 여름 24일에 이사 옴',
                                                    '조카들과 함께 사는 호기심 많은 인간.'],
                                                   ['Jada',
                                                    '인간',
                                                    'Persephone 퀘스트 진행 시',
                                                    '유물 수집가. 박물관 퀘스트 담당.'],
                                                   ['Winston', '인간', 'Persephone 퀘스트 진행 시', '초자연 존재를 무서워함.'],
                                                   ['Saga',
                                                    '늑대인간',
                                                    '마을, Howling Marshes',
                                                    'Orlock과 Brook의 갈등을 풀려고 애씀.'],
                                                   ['Ridge',
                                                    '늑대인간',
                                                    'The Howling Hammer(도구 상점)',
                                                    '도구 강화 판매. Ludo의 아버지.'],
                                                   ['Ludo', '늑대인간', '마을 곳곳', '장난꾸러기 늑대인간.'],
                                                   ['Dragan',
                                                    '예언자',
                                                    '자기 집 근처 / Nokturna',
                                                    '예지로 고민하는 카드 플레이어.'],
                                                   ['Alina', '예언자', 'Dragan의 집 근처', '강렬하고 열정적인 예언자.'],
                                                   ['Aras',
                                                    '예언자',
                                                    'Third Eye Threads(패션)',
                                                    '친절하고 부드러운 말투의 가게 주인.'],
                                                   ['Death', '초자연 존재', '지하 묘지 근처', '일에 지침. 벌레채를 줌.'],
                                                   ['Llemi', '초자연 존재', 'Lovage 축제 전', '사랑의 악마. 데이트 가능.'],
                                                   ['Kim / Tae / Rei', '인어', '숨김', '비밀 연애 후보.'],
                                                   ['Viktor', 'NPC', '돔 건물', 'Red Wine 퀘스트를 줌. 치즈를 좋아함.'],
                                                   ['Brook', 'NPC', '마을 회관 / 시장', '늑대인간 시장. 당신을 등록함.'],
                                                   ['Jarvis', 'NPC', '마을 곳곳(유령)', 'Chalice에 대해 알려줌.'],
                                                   ['Chester', 'NPC', '내 농장', '출하 몬스터.']]}},
                               'fr': {0: {'rows': [['Fiona',
                                                    'Sorcière',
                                                    'Cercle du coven / zone Webb of Wonders',
                                                    'Sorcière distante en conflit avec Orlock.'],
                                                   ['Noel',
                                                    'Sorcière',
                                                    'Rivières et côte',
                                                    'Sorcière-pêcheuse arrogante ; hautaine en surface.'],
                                                   ['Sabrina',
                                                    'Sorcière',
                                                    'Webb of Wonders (boutique magique)',
                                                    'Vend sorts, améliorations de mana et emplacements '
                                                    "d'inventaire."],
                                                   ['Luna',
                                                    'Sorcière',
                                                    'Sa ferme à Moonlit Pines / banc de la mairie',
                                                    'Vend graines et animaux ; adore toute fleur.'],
                                                   ['Orlock',
                                                    'Vampire',
                                                    'Ambrosia Mansion / The Broken Lamp',
                                                    "Vampire tourmenté en convalescence d'un problème "
                                                    "d'alcool."],
                                                   ['Evan',
                                                    'Vampire',
                                                    'Coffee and Coffins',
                                                    "Décontracté ; l'enfant d'Orlock."],
                                                   ['Mina',
                                                    'Vampire',
                                                    'Coffee and Coffins',
                                                    "Vive et enthousiaste ; l'autre enfant d'Orlock."],
                                                   ['Samael',
                                                    'Vampire',
                                                    'The Broken Lamp (après 23 h)',
                                                    'Sombre, mystérieux, gentil.'],
                                                   ['Elvira',
                                                    'Vampire',
                                                    'En ville / organise des rassemblements',
                                                    "Organisatrice pleine d'entrain."],
                                                   ['Persephone',
                                                    'Humaine',
                                                    "Arrive le 24 d'été, an 1",
                                                    'Humaine curieuse avec nièce et neveu.'],
                                                   ['Jada',
                                                    'Humaine',
                                                    'Quêtes de Persephone',
                                                    'Collectionneuse de reliques ; mène la quête du musée.'],
                                                   ['Winston',
                                                    'Humain',
                                                    'Quêtes de Persephone',
                                                    'Peur du surnaturel.'],
                                                   ['Saga',
                                                    'Loup-garou',
                                                    'Ville, Howling Marshes',
                                                    "Tente d'apaiser la querelle Orlock–Brook."],
                                                   ['Ridge',
                                                    'Loup-garou',
                                                    "The Howling Hammer (boutique d'outils)",
                                                    "Vend des améliorations d'outils ; père de Ludo."],
                                                   ['Ludo', 'Loup-garou', 'En ville', 'Loup-garou farceur.'],
                                                   ['Dragan',
                                                    'Voyant',
                                                    'Près de sa maison / Nokturna',
                                                    'Joueur de cartes en proie aux visions.'],
                                                   ['Alina',
                                                    'Voyante',
                                                    'Près de la maison de Dragan',
                                                    'Voyante intense et passionnée.'],
                                                   ['Aras',
                                                    'Voyant',
                                                    'Third Eye Threads (mode)',
                                                    'Commerçant gentil et doux.'],
                                                   ['Death',
                                                    'Surnaturel',
                                                    'Près des Catacombes',
                                                    'Las de son travail ; donne le filet à insectes.'],
                                                   ['Llemi',
                                                    'Surnaturel',
                                                    'Avant le festival Lovage',
                                                    "Démon de l'amour ; romance possible."],
                                                   ['Kim / Tae / Rei',
                                                    'Sirène',
                                                    'Caché',
                                                    'Candidats romance secrets.'],
                                                   ['Viktor',
                                                    'PNJ',
                                                    'Bâtiment du dôme',
                                                    'Donne la quête Red Wine ; aime le fromage.'],
                                                   ['Brook',
                                                    'PNJ',
                                                    'Mairie / maire',
                                                    'Maire loup-garou ; vous enregistre.'],
                                                   ['Jarvis',
                                                    'PNJ',
                                                    'En ville (fantôme)',
                                                    'Vous parle du Chalice.'],
                                                   ['Chester',
                                                    'PNJ',
                                                    'Votre ferme',
                                                    "Monstre d'expédition."]]}},
                               'de': {0: {'rows': [['Fiona',
                                                    'Hexe',
                                                    'Zirkelkreis / Bereich Webb of Wonders',
                                                    'Distanzierte Hexe im Streit mit Orlock.'],
                                                   ['Noel',
                                                    'Hexe',
                                                    'Flüsse & Küste',
                                                    'Arrogante Angelhexe; oberflächlich hochmütig.'],
                                                   ['Sabrina',
                                                    'Hexe',
                                                    'Webb of Wonders (Zauberladen)',
                                                    'Verkauft Zauber, Mana-Upgrades und Inventarplätze.'],
                                                   ['Luna',
                                                    'Hexe',
                                                    'Ihre Farm in Moonlit Pines / Bank am Rathaus',
                                                    'Verkauft Samen und Tiere; liebt jede Blume.'],
                                                   ['Orlock',
                                                    'Vampir',
                                                    'Ambrosia Mansion / The Broken Lamp',
                                                    'Geplagter Vampir, der sich von Alkoholproblemen '
                                                    'erholt.'],
                                                   ['Evan',
                                                    'Vampir',
                                                    'Coffee and Coffins',
                                                   ...
                                                   ['Mina',
                                                    'Vampir',
                                                    'Coffee and Coffins',
                                                    'Fröhlich und aufgedreht; Orlocks anderes Kind.'],
                                                   ['Samael',
                                                    'Vampir',
                                                    'The Broken Lamp (nach 23:00)',
                                                    'Düster, geheimnisvoll, freundlich.'],
                                                   ['Elvira',
                                                    'Vampir',
                                                    'In der Stadt / organisiert Treffen',
                                                    'Temperamentvolle Event-Organisatorin.'],
                                                   ['Persephone',
                                                    'Mensch',
                                                    'Zieht am 24. Sommer, Jahr 1 ein',
                                                    'Neugieriger Mensch mit Nichte und Neffe.'],
                                                   ['Jada',
                                                    'Mensch',
                                                    'Mit Persephones Quests',
                                                    'Reliktsammlerin; leitet die Museums-Quest.'],
                                                   ['Winston',
                                                    'Mensch',
                                                    'Mit Persephones Quests',
                                                    'Hat Angst vor Übernatürlichem.'],
                                                   ['Saga',
                                                    'Werwolf',
                                                    'Stadt, Howling Marshes',
                                                    'Versucht, den Orlock–Brook-Streit zu schlichten.'],
                                                   ['Ridge',
                                                    'Werwolf',
                                                    'The Howling Hammer (Werkzeugladen)',
                                                    'Verkauft Werkzeug-Upgrades; Vater von Ludo.'],
                                                   ['Ludo',
                                                    'Werwolf',
                                                    'In der Stadt',
                                                    'Streiche spielender Werwolf.'],
                                                   ['Dragan',
                                                    'Seher',
                                                    'Nahe seinem Haus / Nokturna',
                                                    'Mit Visionen ringender Kartenspieler.'],
                                                   ['Alina',
                                                    'Seherin',
                                                    'Nahe Dragans Haus',
                                                    'Intensive, leidenschaftliche Seherin.'],
                                                   ['Aras',
                                                    'Seher',
                                                    'Third Eye Threads (Mode)',
                                                    'Freundlicher, leiser Ladenbesitzer.'],
                                                   ['Death',
                                                    'Übernaturwesen',
                                                    'Nahe den Katakomben',
                                                    'Müde von seinem Job; gibt das Kescher.'],
                                                   ['Llemi',
                                                    'Übernaturwesen',
                                                    'Vor dem Lovage-Fest',
                                                    'Liebesdämon; datierbar.'],
                                                   ['Kim / Tae / Rei',
                                                    'Meerjungfrau',
                                                    'Versteckt',
                                                    'Geheime Romantik-Kandidaten.'],
                                                   ['Viktor',
                                                    'NPC',
                                                    'Kuppelgebäude',
                                                    'Gibt die Red-Wine-Quest; mag Käse.'],
                                                   ['Brook',
                                                    'NPC',
                                                    'Rathaus / Bürgermeister',
                                                    'Werwolf-Bürgermeister; registriert dich.'],
                                                   ['Jarvis',
                                                    'NPC',
                                                    'In der Stadt (Geist)',
                                                    'Erzählt dir vom Chalice.'],
                                                   ['Chester', 'NPC', 'Deine Farm', 'Versandmonster.']]}}},
 'moonlight-peaks/potions': {'ja': {0: {'rows': [['Alter Ego Elixir',
                                                  '外見を変える',
                                                  'Quartz Dust, Nightshade Powder, Honey',
                                                  '1,000'],
                                                 ['Sunscreen Potion', '日光から身を守る', 'Fiber, Egg', '45'],
                                                 ['Mindless Miner Tonic',
                                                  '採掘中のスタミナ消費をなくす',
                                                  'Gold Ore, Leftsee, Glowglammer, Nightshade Powder',
                                                  '1,300'],
                                                 ['Frictionless Farming Tonic',
                                                  '農作業中のスタミナ消費をなくす',
                                                  'Onion, Honey, Googly Garlic Powder, Heart Stone',
                                                  '990'],
                                                 ['Fluent Fishing Tonic',
                                                  '釣り中のスタミナ消費をなくす',
                                                  'Splotch, Glow Ginger Powder, Sugar, Volacio Mushroom',
                                                  '700'],
                                                 ['Fierce Forester Tonic',
                                                  '薪割り中のスタミナ消費をなくす',
                                                  'Sage Powder, Amanita, Light Wood, Cranberry',
                                                  '950'],
                                                 ['Rapid Reel Potion',
                                                  '魚がほぼ即座に食いつく',
                                                  'Angry Mandrake, Wolfsbane Powder, Sugar, Whisper',
                                                  '700'],
                                                 ['Love Potion',
                                                  '贈り物で得る好感度がわずかに上がる',
                                                  'Hold-Me-Close, Muse Nut, Amour, Suffrain Powder, Luck '
                                                  'Dust',
                                                  '2,200'],
                                                 ['Mana Potion',
                                                  'マナを8回復する',
                                                  'Mana Essence, Drikker, Henbane Powder, Violet, Frosteria',
                                                  '3,200']]}},
                             'ko': {0: {'rows': [['Alter Ego Elixir',
                                                  '외형 변경',
                                                  'Quartz Dust, Nightshade Powder, Honey',
                                                  '1,000'],
                                                 ['Sunscreen Potion', '햇빛으로부터 보호', 'Fiber, Egg', '45'],
                                                 ['Mindless Miner Tonic',
                                                  '채광 중 스태미나 소모 제거',
                                                  'Gold Ore, Leftsee, Glowglammer, Nightshade Powder',
                                                  '1,300'],
                                                 ...
                                                 ['Mana Potion',
                                                  ...
                                                  'Mana Essence, Drikker, Henbane Powder, Violet, Frosteria',
                                                  '3,200']]}},
                             'fr': {0: {'rows': [['Alter Ego Elixir',
                                                  'Change votre apparence',
                                                  'Quartz Dust, Nightshade Powder, Honey',
                                                  '1 000'],
                                                 ['Sunscreen Potion',
                                                  'Vous protège du soleil',
                                                  'Fiber, Egg',
                                                  '45'],
                                                 ['Mindless Miner Tonic',
                                                  "Supprime le coût d'énergie en minant",
                                                  'Gold Ore, Leftsee, Glowglammer, Nightshade Powder',
                                                  '1 300'],
                                                 ['Frictionless Farming Tonic',
                                                  "Supprime le coût d'énergie en cultivant",
                                                  'Onion, Honey, Googly Garlic Powder, Heart Stone',
                                                  '990'],
                                                 ['Fluent Fishing Tonic',
                                                  "Supprime le coût d'énergie en pêchant",
                                                  'Splotch, Glow Ginger Powder, Sugar, Volacio Mushroom',
                                                  '700'],
                                                 ['Fierce Forester Tonic',
                                                  "Supprime le coût d'énergie en coupant du bois",
                                                  'Sage Powder, Amanita, Light Wood, Cranberry',
                                                  '950'],
                                                 ['Rapid Reel Potion',
                                                  'Les poissons mordent presque instantanément',
                                                  'Angry Mandrake, Wolfsbane Powder, Sugar, Whisper',
                                                  '700'],
                                                 ['Love Potion',
                                                  "Augmente légèrement l'amitié gagnée par les cadeaux",
                                                  'Hold-Me-Close, Muse Nut, Amour, Suffrain Powder, Luck '
                                                  'Dust',
                                                  '2 200'],
                                                 ['Mana Potion',
                                                  ...
                                                  'Mana Essence, Drikker, Henbane Powder, Violet, Frosteria',
                                                  '3 200']]}},
                             'de': {0: {'rows': [['Alter Ego Elixir',
                                                  'Verändert dein Aussehen',
                                                  'Quartz Dust, Nightshade Powder, Honey',
                                                  '1.000'],
                                                 ['Sunscreen Potion',
                                                  'Schützt dich vor Sonnenlicht',
                                                  'Fiber, Egg',
                                                  '45'],
                                                 ['Mindless Miner Tonic',
                                                  'Entfernt die Energiekosten beim Bergbau',
                                                  'Gold Ore, Leftsee, Glowglammer, Nightshade Powder',
                                                  '1.300'],
                                                 ['Frictionless Farming Tonic',
                                                  'Entfernt die Energiekosten beim Farmen',
                                                  'Onion, Honey, Googly Garlic Powder, Heart Stone',
                                                  '990'],
                                                 ['Fluent Fishing Tonic',
                                                  'Entfernt die Energiekosten beim Angeln',
                                                  'Splotch, Glow Ginger Powder, Sugar, Volacio Mushroom',
                                                  '700'],
                                                 ['Fierce Forester Tonic',
                                                  'Entfernt die Energiekosten beim Holzhacken',
                                                  'Sage Powder, Amanita, Light Wood, Cranberry',
                                                  '950'],
                                                 ['Rapid Reel Potion',
                                                  'Fische beißen fast sofort an',
                                                  'Angry Mandrake, Wolfsbane Powder, Sugar, Whisper',
                                                  '700'],
                                                 ['Love Potion',
                                                  'Erhöht leicht die durch Geschenke gewonnene Freundschaft',
                                                  'Hold-Me-Close, Muse Nut, Amour, Suffrain Powder, Luck '
                                                  'Dust',
                                                  '2.200'],
                                                 ['Mana Potion',
                                                  'Stellt 8 Mana wieder her',
                                                  'Mana Essence, Drikker, Henbane Powder, Violet, Frosteria',
                                                  '3.200']]}}},
 'moonlight-peaks/museum': {'ja': {2: {'rows': [["Death's Tomb", 'Death と最大の友好度になる。'],
                                                ['Chakra Tuner', '月の女神と最大の友好度になる。'],
                                                ["Sun God's Halo", '太陽神と最大の友好度になる。'],
                                                ["Llemi's Bow", 'Llemi と最大の友好度になる。']]}},
                            'ko': {2: {'rows': [["Death's Tomb", 'Death와 최대 호감도 달성.'],
                                                ['Chakra Tuner', '달의 여신과 최대 호감도 달성.'],
                                                ["Sun God's Halo", '태양신과 최대 호감도 달성.'],
                                                ["Llemi's Bow", 'Llemi와 최대 호감도 달성.']]}},
                            'fr': {2: {'rows': [["Death's Tomb", "Atteindre l'amitié maximale avec Death."],
                                                ['Chakra Tuner',
                                                 "Atteindre l'amitié maximale avec la déesse de la lune."],
                                                ["Sun God's Halo",
                                                 "Atteindre l'amitié maximale avec le dieu du soleil."],
                                                ["Llemi's Bow", "Atteindre l'amitié maximale avec Llemi."]]}},
                            'de': {2: {'rows': [["Death's Tomb", 'Erreiche maximale Freundschaft mit Death.'],
                                                ['Chakra Tuner',
                                                 'Erreiche maximale Freundschaft mit der Mondgöttin.'],
                                                ["Sun God's Halo",
                                                 'Erreiche maximale Freundschaft mit dem Sonnengott.'],
                                                ["Llemi's Bow",
                                                 'Erreiche maximale Freundschaft mit Llemi.']]}}},
 'moonlight-peaks/breeding': {'ja': {1: {'rows': [['Cheeken',
                                                   '「Farm Animals for Sale」クエスト',
                                                   '1,200',
                                                   'Egg, Golden Egg'],
                                                  ['Pig Goat', '納屋を建てる', '3,500', 'Piggoat Milk'],
                                                  ['Draculamb', '納屋を建てる', '4,500', 'Draculamb Milk, Wool'],
                                                  ['Cowcula', '納屋を建てる', '6,000', 'Cowcula Milk'],
                                                  ['Bumpkin', '1年目の秋まで進める', '12,000', 'Plops（堆肥）'],
                                                  ['Stoney', '1年目の冬まで進める', '9,000', 'Heart Stone'],
                                                  ['Rabbicula', '2年目の春まで進める', '2,800', '未定']]}},
                              'ko': {1: {'rows': [['Cheeken',
                                                   "'Farm Animals for Sale' 퀘스트",
                                                   '1,200',
                                                   'Egg, Golden Egg'],
                                                  ['Pig Goat', '헛간 짓기', '3,500', 'Piggoat Milk'],
                                                  ['Draculamb', '헛간 짓기', '4,500', 'Draculamb Milk, Wool'],
                                                  ['Cowcula', '헛간 짓기', '6,000', 'Cowcula Milk'],
                                                  ['Bumpkin', '1년차 가을 도달', '12,000', 'Plops(퇴비)'],
                                                  ['Stoney', '1년차 겨울 도달', '9,000', 'Heart Stone'],
                                                  ['Rabbicula', '2년차 봄 도달', '2,800', '미정']]}},
                              'fr': {1: {'rows': [['Cheeken',
                                                   "Quête 'Farm Animals for Sale'",
                                                   '1 200',
                                                   'Egg, Golden Egg'],
                                                  ['Pig Goat',
                                                   'Construire une grange',
                                                   '3 500',
                                                   'Piggoat Milk'],
                                                  ['Draculamb',
                                                   'Construire une grange',
                                                  ...
                                                  ['Cowcula',
                                                   ...
                                                   'Cowcula Milk'],
                                                  ['Bumpkin',
                                                   "Atteindre l'automne (an 1)",
                                                   '12 000',
                                                   'Plops (compost)'],
                                                  ['Stoney',
                                                   "Atteindre l'hiver (an 1)",
                                                   '9 000',
                                                   'Heart Stone'],
                                                  ['Rabbicula',
                                                   'Atteindre le printemps (an 2)',
                                                   '2 800',
                                                   'à compléter']]}},
                              'de': {1: {'rows': [['Cheeken',
                                                   "Quest 'Farm Animals for Sale'",
                                                   '1.200',
                                                   'Egg, Golden Egg'],
                                                  ['Pig Goat', 'Baue eine Scheune', '3.500', 'Piggoat Milk'],
                                                  ['Draculamb',
                                                   'Baue eine Scheune',
                                                   '4.500',
                                                   'Draculamb Milk, Wool'],
                                                  ['Cowcula', 'Baue eine Scheune', '6.000', 'Cowcula Milk'],
                                                  ['Bumpkin',
                                                   'Erreiche den Herbst (Jahr 1)',
                                                   '12.000',
                                                   'Plops (Kompost)'],
                                                  ['Stoney',
                                                   'Erreiche den Winter (Jahr 1)',
                                                   '9.000',
                                                   'Heart Stone'],
                                                  ['Rabbicula',
                                                   'Erreiche den Frühling (Jahr 2)',
                                                   '2.800',
                                                   'offen']]}}},
 'moonlight-peaks/updates': {'ja': {0: {'rows': [['1.1.45',
                                                  '2026-07-21',
                                                  '起動時の光過敏警告を追加。ワイド画面で黒帯に隠れる Star Gazing の看板を修正。Loveage Gift '
                                                  'Exchange のソフトロックを修正。Pumpkin Head のハートイベント後に Luna '
                                                  'の店の動物が消える問題を修正。Howling Marshes の Weeping Willows '
                                                  'の再出現を強化。「Back to the Den」が発動するように（全 Vampster '
                                                  '返却後、ゲーム内1日で遡及付与）。Recover the Moon クエストからの脱出を修正。Bee House '
                                                  '/ Firefly Sanctuary のメモリリークを修正。マウス・Farm '
                                                  'Helpers・アイテム拾いのパフォーマンス、テキスト修正。さらなる改善は1.2で予定。'],
                                                 ['1.1.44',
                                                  '2026-07-16',
                                                  '見えない刺繍テーブルを修正。家のアップグレード後のロード失敗を修正。樹木の種が全季節で植えられ、正しい季節を表示するように。テーブル・棚の装飾がインベントリスロットを消費しないように。雨の夜に作物が成長しないように。セーブ中の終了によるセーブ破損を修正（Steamのみ）。'],
                                                 ['1.1.41',
                                                  '2026-07-15',
                                                  'ロード高速化。敷地全体（納屋・温室）の家の収納＋Quick '
                                                  'Transfer。刺繍が早期に解放。樹木の種が季節を表示。23以上のバグ修正（網の空振りのスタミナ、セーブ復元、作物成長、カットシーン発動、贈り物の反応、家のアップグレード時のインベントリ消失、Steam '
                                                  'Deck 操作、ゲームパッド、クラフト品の品質）。'],
                                                 ['1.1.38',
                                                  '2026-07-10',
                                                  '5〜20秒ごとの短いフリーズを修正。ドアから出た後にゆっくり歩くアニメが固まる問題を修正。Nokturna '
                                                  'の「新規カード」ソフトロックを修正。'],
                                                 ['1.0（発売）',
                                                  '2026-07-06/07',
                                                  'PC（Steam）、Switch、Switch 2、Google Play Games '
                                                  'で発売。7月26日までに20万本を突破。']]}},
                             'ko': {0: {'rows': [['1.1.45',
                                                  '2026-07-21',
                                                  '시작 시 광과민성 경고 추가. 와이드 화면에서 검은 띠에 가려지던 Star Gazing 표지판 수정. '
                                                  'Loveage Gift Exchange 소프트록 수정. Pumpkin Head 하트 이벤트 후 Luna '
                                                  '상점의 동물이 사라지던 문제 수정. Howling Marshes의 Weeping Willows 재생성 '
                                                  "강화. 'Back to the Den'이 이제 발동(Vampster 전원 반환 후 게임 내 하루 뒤 "
                                                  '소급 지급). Recover the Moon 퀘스트 탈출 수정. Bee House / Firefly '
                                                  'Sanctuary 메모리 누수 수정. 마우스·Farm Helpers·아이템 줍기 성능, 텍스트 수정. '
                                                  '추가 개선은 1.2에서.'],
                                                 ['1.1.44',
                                                  '2026-07-16',
                                                  '보이지 않던 자수 테이블 수정. 집 업그레이드 후 로딩 실패 수정. 나무 씨앗을 모든 계절에 심을 수 '
                                                  '있고 올바른 계절을 표시. 테이블/선반 장식이 인벤토리 슬롯을 차지하지 않음. 비 오는 밤 작물이 '
                                                  '자라지 않음. 저장 중 종료로 인한 세이브 손상 수정(Steam 전용).'],
                                                 ['1.1.41',
                                                  '2026-07-15',
                                                  '로딩 개선. 부지 전체(헛간·온실)의 집 창고 + Quick Transfer. 자수가 더 일찍 해금. '
                                                  '나무 씨앗이 계절 표시. 23개 이상의 버그 수정(그물 헛스윙 스태미나, 세이브 복원, 작물 성장, '
                                                  '컷신 발동, 선물 반응, 집 업그레이드 인벤토리 손실, Steam Deck 조작, 게임패드, 제작품 '
                                                  '품질).'],
                                                 ['1.1.38',
                                                  '2026-07-10',
                                                  '5~20초마다 짧은 프리즈 수정. 문을 나간 후 느린 걷기 애니메이션이 멈추던 문제 수정. '
                                                  "Nokturna '새 카드' 소프트록 수정."],
                                                 ['1.0(출시)',
                                                  '2026-07-06/07',
                                                  'PC(Steam), Switch, Switch 2, Google Play Games 출시. 7월 '
                                                  '26일까지 20만 장 돌파.']]}},
                             'fr': {0: {'rows': [['1.1.45',
                                                  '2026-07-21',
                                                  "Ajout d'un avertissement de photosensibilité au démarrage "
                                                  '; correction des panneaux Star Gazing masqués par des '
                                                  'barres noires en écran large ; correction du soft lock '
                                                  'Loveage Gift Exchange ; correction des animaux '
                                                  "disparaissant de la boutique de Luna après l'événement de "
                                                  'cœur de Pumpkin Head ; respawn accru des Weeping Willows '
                                                  "dans les Howling Marshes ; 'Back to the Den' se déclenche "
                                                  'désormais (octroi rétroactif un jour après le retour de '
                                                  "tous les Vampsters) ; correction de l'échappée de la "
                                                  'quête Recover the Moon ; correction des fuites mémoire '
                                                  'Bee House / Firefly Sanctuary ; performances souris, Farm '
                                                  "Helpers et ramassage d'objets ; corrections de texte. "
                                                  "D'autres améliorations arrivent en 1.2."],
                                                 ['1.1.44',
                                                  '2026-07-16',
                                                  'Correction de la table de broderie invisible ; correction '
                                                  "de l'échec de chargement après l'amélioration de la "
                                                  "maison ; les graines d'arbres sont plantables toutes "
                                                  'saisons et affichent la bonne saison ; les décorations '
                                                  "sur tables/étagères ne consomment plus d'emplacements ; "
                                                  'les cultures ne poussent plus les nuits de pluie ; '
                                                  "correction d'une sauvegarde corrompue en quittant pendant "
                                                  'la sauvegarde (Steam uniquement).'],
                                                 ['1.1.41',
                                                  '2026-07-15',
                                                  'Chargement plus rapide ; stockage de maison sur tout le '
                                                  'terrain (granges/serres) avec transfert rapide ; broderie '
                                                  "débloquée plus tôt ; les graines d'arbres affichent les "
                                                  'saisons ; 23+ corrections (énergie des coups de filet '
                                                  'ratés, restauration de sauvegarde, croissance des '
                                                  'cultures, déclenchement des cinématiques, réactivité des '
                                                  "cadeaux, pertes d'inventaire à l'amélioration de la "
                                                  'maison, contrôles Steam Deck, manette, qualité des objets '
                                                  'fabriqués).'],
                                                 ['1.1.38',
                                                  '2026-07-10',
                                                  'Correction de courts gels toutes les 5–20 s ; correction '
                                                  "de l'animation de marche lente bloquée après la sortie "
                                                  "des portes ; correction du soft lock 'nouvelle carte' de "
                                                  'Nokturna.'],
                                                 ['1.0 (Lancement)',
                                                  '2026-07-06/07',
                                                  'Sorti sur PC (Steam), Switch, Switch 2 et Google Play '
                                                  'Games. Plus de 200 000 ventes au 26 juillet.']]}},
                             'de': {0: {'rows': [['1.1.45',
                                                  '2026-07-21',
                                                  'Fotosensibilitäts-Warnung beim Start hinzugefügt; '
                                                  'Star-Gazing-Schilder, die im Breitbild von schwarzen '
                                                  'Balken verdeckt wurden, korrigiert; '
                                                  'Loveage-Geschenk-Softlock behoben; verschwindende Tiere '
                                                  'in Lunas Laden nach Pumpkin Heads Herz-Event behoben; '
                                                  'Weeping-Willows-Respawn in den Howling Marshes erhöht; '
                                                  "'Back to the Den' wird nun ausgelöst (nachträgliche "
                                                  'Gewährung einen Spieltag nach Rückkehr aller Vampster); '
                                                  'Entkommen aus der Recover-the-Moon-Quest behoben; '
                                                  'Speicherlecks bei Bee House / Firefly Sanctuary behoben; '
                                                  'Maus-, Farm-Helfer- und Aufsammel-Performance; '
                                                  'Textkorrekturen. Weitere Verbesserungen kommen in 1.2.'],
                                                 ['1.1.44',
                                                  '2026-07-16',
                                                  'Unsichtbaren Sticktisch behoben; Ladefehler nach '
                                                  'Haus-Upgrade behoben; Baumsamen sind jetzt ganzjährig '
                                                  'pflanzbar und zeigen die richtige Jahreszeit; Deko auf '
                                                  'Tischen/Regalen verbraucht keine Inventarplätze mehr; '
                                                  'Pflanzen wachsen in Regennächten nicht mehr; korrupten '
                                                  'Speicherstand durch Beenden beim Speichern behoben (nur '
                                                  'Steam).'],
                                                 ['1.1.41',
                                                  '2026-07-15',
                                                  'Schnelleres Laden; Hauslager auf dem ganzen Grundstück '
                                                  '(Scheunen/Gewächshäuser) mit Schnellübertragung; '
                                                  'Stickerei früher freigeschaltet; Baumsamen zeigen '
                                                  'Jahreszeiten; 23+ Fehlerbehebungen (Energie bei '
                                                  'verfehlten Netzschwüngen, Speicher-Wiederherstellung, '
                                                  'Pflanzenwachstum, Zwischensequenz-Auslöser, '
                                                  'Geschenk-Reaktivität, Inventarverluste bei Haus-Upgrades, '
                                                  'Steam-Deck-Steuerung, Gamepad, Qualität gefertigter '
                                                  'Gegenstände).'],
                                                 ['1.1.38',
                                                  '2026-07-10',
                                                  'Kurze Hänger alle 5–20 s behoben; hängenbleibende '
                                                  'Langsam-Geh-Animation nach dem Verlassen von Türen '
                                                  "behoben; Nokturna-'Neue-Karte'-Softlock behoben."],
                                                 ['1.0 (Start)',
                                                  '2026-07-06/07',
                                                  'Veröffentlicht auf PC (Steam), Switch, Switch 2 und '
                                                  'Google Play Games. Über 200.000 Verkäufe bis 26. '
                                                  'Juli.']]}}},
 'moonlight-peaks/steam-deck': {'ja': {0: {'rows': [['コントローラー対応',
                                                     'フルコントローラー対応＋Gamepad Recommended（Steam 公式分類）。'],
                                                    ['Steam Deck 操作',
                                                     'パッチ1.1.41（2026-07-15）に Steam Deck 操作の修正が含まれる。'],
                                                    ['セーブ / クラウド', 'Steam クラウド対応。'],
                                                    ['Deck での性能', 'コミュニティ報告はまだ未収集 — 未定。'],
                                                    ['公式 Verified ステータス', '未定（ストアページで未確認）。']]}},
                                'ko': {0: {'rows': [['컨트롤러 지원',
                                                     '전체 컨트롤러 지원 + Gamepad Recommended(Steam 공식 분류).'],
                                                    ['Steam Deck 조작',
                                                     '패치 1.1.41(2026-07-15)에 Steam Deck 조작 수정 포함.'],
                                                    ['세이브 / 클라우드', 'Steam 클라우드 지원.'],
                                                    ['Deck 성능', '커뮤니티 보고 미수집 — 미정.'],
                                                    ['공식 Verified 상태', '미정(스토어 페이지에서 미확인).']]}},
                                'fr': {0: {'rows': [['Prise en charge manette',
                                                     'Prise en charge manette complète + Gamepad Recommended '
                                                     '(catégories officielles Steam).'],
                                                    ['Contrôles Steam Deck',
                                                     'Le patch 1.1.41 (2026-07-15) inclut des correctifs de '
                                                     'contrôles Steam Deck.'],
                                                    ['Sauvegarde / Cloud', 'Steam Cloud pris en charge.'],
                                                    ['Performances sur Deck',
                                                     'Retours communautaires pas encore collectés — à '
                                                     'compléter.'],
                                                    ['Statut Verified officiel',
                                                     'à compléter (pas encore confirmé sur la page du '
                                                     'magasin).']]}},
                                'de': {0: {'rows': [['Controller-Unterstützung',
                                                     'Volle Controller-Unterstützung + Gamepad Recommended '
                                                     '(offizielle Steam-Kategorien).'],
                                                    ['Steam-Deck-Steuerung',
                                                     'Patch 1.1.41 (2026-07-15) enthielt '
                                                     'Steam-Deck-Steuerungsfixes.'],
                                                    ['Speichern / Cloud', 'Steam Cloud unterstützt.'],
                                                    ['Leistung auf dem Deck',
                                                     'Community-Berichte noch nicht gesammelt — offen.'],
                                                    ['Offizieller Verified-Status',
                                                     'offen (auf der Shop-Seite noch nicht bestätigt).']]}}},
 'moonlight-peaks/console': {'ja': {0: {'rows': [['PC（Steam）', '2026-07-06', 'Windows + macOS（Linux 非対応）。'],
                                                 ['Nintendo Switch', '2026-07-07', 'Marvelous（XSEED）が発売。'],
                                                 ['Nintendo Switch 2',
                                                  '2026-07-07',
                                                  '「Moonlight Peaks - Nintendo Switch 2 Edition」として販売。'],
                                                 ['Google Play Games（Android）',
                                                  '2026-07-07',
                                                  'Google Play Games 経由で PC/Android をプレイ。']]}},
                             'ko': {0: {'rows': [['PC(Steam)', '2026-07-06', 'Windows + macOS(Linux 미지원).'],
                                                 ['Nintendo Switch', '2026-07-07', 'Marvelous(XSEED)가 배급.'],
                                                 ['Nintendo Switch 2',
                                                  '2026-07-07',
                                                  "'Moonlight Peaks - Nintendo Switch 2 Edition'으로 판매."],
                                                 ['Google Play Games(Android)',
                                                  '2026-07-07',
                                                  'Google Play Games를 통해 PC/Android 플레이.']]}},
                             'fr': {0: {'rows': [['PC (Steam)',
                                                  '2026-07-06',
                                                  'Windows + macOS (pas de Linux).'],
                                                 ['Nintendo Switch',
                                                  '2026-07-07',
                                                  'Édité par Marvelous (XSEED).'],
                                                 ['Nintendo Switch 2',
                                                  '2026-07-07',
                                                  "Disponible en 'Moonlight Peaks - Nintendo Switch 2 "
                                                  "Edition'."],
                                                 ['Google Play Games (Android)',
                                                  '2026-07-07',
                                                  'Jouable sur PC/Android via Google Play Games.']]}},
                             'de': {0: {'rows': [['PC (Steam)',
                                                  '2026-07-06',
                                                  'Windows + macOS (kein Linux).'],
                                                 ['Nintendo Switch',
                                                  '2026-07-07',
                                                  'Veröffentlicht von Marvelous (XSEED).'],
                                                 ['Nintendo Switch 2',
                                                  '2026-07-07',
                                                  "Erhältlich als 'Moonlight Peaks - Nintendo Switch 2 "
                                                  "Edition'."],
                                                 ['Google Play Games (Android)',
                                                  '2026-07-07',
                                                  'PC/Android über Google Play Games.']]}}},
 'moonlight-peaks/system-requirements': {'ja': {0: {'rows': [['OS', 'Windows 10 64ビット', 'Windows 10 64ビット'],
                                                             ['プロセッサ', 'Intel i3', 'Intel i7 / Ryzen 1700+'],
                                                             ['メモリ', '6 GB RAM', '16 GB RAM'],
                                                             ['グラフィック',
                                                              'Nvidia GeForce GTX 660 2GB',
                                                              'Nvidia GeForce GTX 960+'],
                                                             ['DirectX', 'バージョン10', 'バージョン10'],
                                                             ['ストレージ', '8 GB 空き', '8 GB 空き']]}},
                                         'ko': {0: {'rows': [['OS', 'Windows 10 64비트', 'Windows 10 64비트'],
                                                             ['프로세서', 'Intel i3', 'Intel i7 / Ryzen 1700+'],
                                                             ['메모리', '6 GB RAM', '16 GB RAM'],
                                                             ['그래픽',
                                                              'Nvidia GeForce GTX 660 2GB',
                                                              'Nvidia GeForce GTX 960+'],
                                                             ['DirectX', '버전 10', '버전 10'],
                                                             ['저장 공간', '8 GB 여유', '8 GB 여유']]}},
                                         'fr': {0: {'rows': [["Système d'exploitation",
                                                              'Windows 10 64 bits',
                                                              'Windows 10 64 bits'],
                                                             ['Processeur',
                                                              'Intel i3',
                                                              'Intel i7 / Ryzen 1700+'],
                                                             ['Mémoire', '6 Go de RAM', '16 Go de RAM'],
                                                             ['Graphismes',
...
# G3 site-writer：把 ja/ko/fr/de 表格正文 rows 审译合并进 MOON_EXTRA，
# 使下方 EXTRA 覆盖循环一并应用（仅覆盖 rows，不动 heading/headers/items）。
for _slug, _langs in MP_ROWS_I18N.items():
    _t = MOON_EXTRA.setdefault(_slug, {})
    for _lg, _secs in _langs.items():
        _s = _t.setdefault(_lg, {})
        for _si, _ov in _secs.items():
            _s.setdefault(_si, {}).update(_ov)
